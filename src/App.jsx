...
const STRESS_TOOLS = [
  { id:1, title:"Box Breathing", category:"Breathwork", duration:"4 minutes", type:"breathing", desc:"A regulation technique used by Navy SEALs to calm the nervous system. Inhale, hold, exhale, hold — each for 4 counts.", steps:["Sit upright with feet flat on the floor.","Inhale slowly through your nose for 4 counts.","Hold your breath for 4 counts.","Exhale through your mouth for 4 counts.","Hold empty for 4 counts.","Repeat 4 to 6 cycles."], benefit:"Activates the parasympathetic nervous system within 90 seconds." },
  { id:2, title:"Physiological Sigh", category:"Breathwork", duration:"1 minute", type:"guide", desc:"A double inhale through the nose followed by a long exhale. The fastest known way to reduce acute stress.", steps:["Take a full inhale through your nose.","At the top, take a second short sniff to fully expand the lungs.","Exhale slowly and completely through your mouth.","Repeat 3 to 5 times."], benefit:"Deflates stress-collapsed air sacs in the lungs and resets the autonomic nervous system." },
  { id:3, title:"5-4-3-2-1 Grounding", category:"Mindfulness", duration:"3 minutes", type:"guide", desc:"A sensory awareness technique that interrupts anxious thought loops by anchoring attention to the present moment.", steps:["Name 5 things you can see.","Name 4 things you can physically feel.","Name 3 things you can hear.","Name 2 things you can smell.","Name 1 thing you can taste."], benefit:"Interrupts the default mode network — the brain region responsible for rumination and worry." },
  { id:4, title:"Progressive Muscle Release", category:"Body", duration:"5 minutes", type:"guide", desc:"Systematically tense and release muscle groups to discharge stored physical tension from stress.", steps:["Start with your feet — tense tightly for 5 seconds.","Release and notice the relaxation for 10 seconds.","Move up: calves, thighs, abdomen, hands, arms, shoulders, face.","End with a full-body release and 3 slow breaths."], benefit:"Reduces cortisol stored in muscle tissue and lowers resting heart rate." },
  { id:5, title:"Cold Water Reset", category:"Body", duration:"2 minutes", type:"guide", desc:"Splashing cold water on your face triggers the dive reflex, instantly calming your heart rate.", steps:["Go to a sink and run cold water.","Splash your face 5 to 10 times.","Hold a wet cloth over your eyes and forehead for 30 seconds.","Breathe slowly throughout."], benefit:"Activates the mammalian dive reflex, reducing heart rate by up to 25%." },
  { id:6, title:"Cognitive Defusion", category:"Mental Reframe", duration:"3 minutes", type:"guide", desc:"A technique from Acceptance and Commitment Therapy. Create distance between yourself and your thoughts.", steps:["Notice a stressful thought you are having.","Instead of saying 'I am overwhelmed', say 'I am having the thought that I am overwhelmed.'","Then say 'I notice I am having the thought that I am overwhelmed.'","Observe the thought without engaging with it.","Let it pass like a cloud."], benefit:"Reduces emotional reactivity by engaging the prefrontal cortex over the amygdala." },
];

const NEURO_TOOLS = [
  { id:1, title:"Meeting Opener: Name and Aim", category:"Meeting Practice", duration:"2 minutes", type:"guide", desc:"Begin each meeting by having each person state their name and one specific intention for the session. Primes the prefrontal cortex for focused engagement.", steps:["Open the meeting 2 minutes early.","Each person states: 'I am [name] and I am here to [specific intention].'","Keep it to one sentence each.","The facilitator closes with the shared goal of the meeting."], benefit:"Activates dopamine-driven goal circuitry, increasing focus and buy-in." },
  { id:2, title:"The 60-Second Reset", category:"Meeting Practice", duration:"1 minute", type:"guide", desc:"A structured pause at the start of any meeting to transition from previous context. Reduces cognitive load and increases presence.", steps:["Ask everyone to close laptops and put phones face down.","Lead one minute of silence or soft background sound.","Ask: 'What do you need to set aside to be fully here?'","Allow 15 seconds of silent acknowledgment.","Begin."], benefit:"Reduces cortisol carryover from prior tasks by up to 40%." },
  { id:3, title:"Affirmation Round", category:"Team Bonding", duration:"5 minutes", type:"guide", desc:"Each team member briefly acknowledges one thing a colleague did well this week. Activates the brain's reward and social bonding circuitry.", steps:["Reserve 5 minutes at the end of a weekly meeting.","Go around — each person names one colleague and one specific action they appreciated.","No long speeches — one or two sentences only.","The named person simply says thank you."], benefit:"Releases oxytocin and serotonin, increasing psychological safety and team cohesion." },
  { id:4, title:"Energy Check-In", category:"Meeting Practice", duration:"2 minutes", type:"guide", desc:"A rapid, low-stakes check-in where team members rate their current energy on a 1 to 10 scale. Surfaces hidden burnout signals early.", steps:["At the start of the meeting, ask everyone to rate their energy: 1 (depleted) to 10 (energized).","Go around briefly — number only, no explanation required.","If average is below 5, consider adjusting the meeting format.","Log the average over time to track team trends."], benefit:"Creates psychological safety and gives managers real-time burnout signal data." },
  { id:5, title:"Two Truths and A Growth", category:"Team Bonding", duration:"5 minutes", type:"guide", desc:"Each person shares two wins and one area of active growth. Builds authentic connection and a learning culture.", steps:["Each person shares two things that went well this week.","And one thing they are actively learning or improving.","No critique or commentary from others.","Rotate who goes first each week."], benefit:"Stimulates neuroplasticity-supporting reflection and normalizes growth mindset." },
  { id:6, title:"Mindful Transition Ritual", category:"Meeting Practice", duration:"3 minutes", type:"guide", desc:"A short closing practice to help teams decompress before their next commitment.", steps:["In the final 3 minutes, stop the agenda.","Ask: 'What is one word that describes how you are leaving this meeting?'","Each person shares their word.","Close with: 'Thank you. Take a full breath before your next task.'"], benefit:"Reduces meeting-to-meeting stress accumulation and increases psychological closure." },
];
