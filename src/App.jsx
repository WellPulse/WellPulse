...
const SUPABASE_KEY = "sb_publishable_oM_JRsfb8PGe37SNYzmg_w0Qr8aIo";
...
const QUESTIONS = [
  ...
  { id: "balance", label: "How is your worklife balance this week?", hint: "1 = No balance · 10 = Well balanced" },
];
...
const NEURO_TOOLS = [
  ...
  { id:4, title:"Energy CheckIn", category:"Meeting Practice · Opening", duration:"2 minutes", type:"guide", desc:"A rapid, lowstakes checkin where team members rate their current energy on a 1 to 10 scale.", steps:["At the start of the meeting, ask everyone to rate their energy: 1 (depleted) to 10 (energized).","Go around briefly — number only, no explanation required.","If the average is below 5, consider adjusting the meeting format or shortening it.","Leaders: log the average over time to track team energy trends."], benefit:"Creates psychological safety and gives managers realtime burnout signal data without requiring anyone to selfdisclose vulnerably." },
  { id:5, title:"Two Truths and A Growth", category:"Team Bonding · Weekly", duration:"5 minutes", type:"guide", desc:"Each person shares two wins and one area of active growth.", steps:["Each person shares two things that went well this week.","And one thing they are actively learning or improving.","No critique or commentary from others.","Rotate who goes first each week."], benefit:"Stimulates neuroplasticitysupporting reflection and normalizes growth mindset across the team." },
  { id:6, title:"Mindful Transition Ritual", category:"Meeting Practice · Closing", duration:"3 minutes", type:"guide", desc:"A short closing practice to help teams decompress before their next commitment.", steps:["In the final 3 minutes, stop the agenda.","Ask: 'What is one word that describes how you are leaving this meeting?'","Each person shares their word — no elaboration needed.","Close with: 'Thank you. Take a full breath before your next task.'"], benefit:"Reduces meetingtomeeting stress accumulation and increases psychological closure, preventing emotional carryover." },
  { id:7, title:"Conflict DeEscalation Protocol", category:"Team Communication · As Needed", duration:"10 minutes", type:"guide", desc:"A structured framework for managers and team members to navigate interpersonal tension.", steps:["Pause the conversation if voices are raised or tension is high.","Each person breathes and identifies what they are feeling.","Reopen with: 'What I need right now is...' rather than 'You always...'","The listener reflects back what they heard before responding.","Together agree on one concrete next step.","If unresolved, agree to revisit in 24 hours with a mediator if needed."], benefit:"Shifts communication from the reactive amygdala to the collaborative prefrontal cortex. Teams using structured deescalation protocols report 34% fewer recurring conflicts." },
  { id:8, title:"Psychological Safety Check", category:"Leadership · Quarterly", duration:"15 minutes", type:"guide", desc:"A selfassessment tool for leaders to evaluate the psychological safety level of their team.", steps:["Rate your team honestly on each statement from 1 (never) to 5 (always):","'People on my team feel safe to speak up without fear of judgment.'","'Mistakes are treated as learning opportunities, not failures.'","'Every person's voice is heard equally in meetings.'","'People ask for help without hesitation.'","'Disagreement is welcomed and handled constructively.'","Score below 15: High priority. Score 1520: Good foundation. Score 2025: Strong culture.","Take one specific action this week based on your lowestscoring statement."], benefit:"Psychological safety is the number one predictor of team performance, innovation, and retention according to Google's Project Aristotle." },
  { id:9, title:"Appreciation Pause", category:"Team Bonding · Daily", duration:"1 minute", type:"guide", desc:"A micropractice that takes 60 seconds and measurably improves team morale.", steps:["Before any meeting or at the start of the day, identify one person on your team.","Think of one specific thing they did recently that made a difference.","Tell them directly — in person, on a call, or in writing.","Be specific: not 'great job' but 'the way you handled that client call yesterday showed real composure.'","Do this every day for 30 days."], benefit:"Specific appreciation activates the brain's reward system more powerfully than general praise. Daily practice correlates with 31% lower voluntary turnover." },
  { id:10, title:"NoMeeting Recovery Block", category:"Workplace Design · Weekly", duration:"2 hours", type:"guide", desc:"A protected time block with no meetings, no Slack, no interruptions.", steps:["Schedule a recurring 2hour block on your calendar.","Mark it as busy. Decline any meeting requests that overlap.","Use this time for your most cognitively demanding work, or for genuine rest.","Communicate to your team: 'This block is protected.'","After 4 weeks, notice the difference in your output quality and stress levels."], benefit:"Research shows it takes an average of 23 minutes to fully regain focus after an interruption. Protecting deep work time is one of the highestleverage burnout prevention strategies available." },
  { id:11, title:"Feedback Framework: SBI", category:"Team Communication · Ongoing", duration:"5 minutes", type:"guide", desc:"SituationBehaviorImpact. A simple, neurosciencealigned feedback framework.", steps:["Situation: Describe the specific situation factually. 'In yesterday's team meeting...'","Behavior: Describe the specific behavior you observed. '...you interrupted three colleagues before they finished speaking.'","Impact: Describe the impact it had. '...which made it harder for their ideas to be heard.'","Pause and invite a response: 'What are your thoughts?'","Listen fully before responding."], benefit:"SBI bypasses the brain's threatdetection system by removing blame and judgment from feedback." },
  { id:12, title:"Team Resilience Retrospective", category:"Leadership · Monthly", duration:"20 minutes", type:"guide", desc:"A structured monthly team conversation that builds collective resilience.", steps:["At the end of each month, hold a dedicated 20minute retrospective.","Question 1: What was the hardest thing we navigated together this month?","Question 2: What did we do well under pressure?","Question 3: What would have made this month easier?","Question 4: What is one thing we want to do differently next month?","Document answers and revisit them the following month."], benefit:"Collective resilience is built through shared meaningmaking after difficulty." },
  { id:13, title:"Stop · Breathe · Reflect · Choose — Team Version", category:"Leadership Practice · Anytime", duration:"2 minutes", type:"guide", desc:"Teach your team this fourstep practice and use it together.", steps:["STOP — Call a pause. Say: 'Before we continue, let's take two minutes.'","BREATHE — Lead one breath together. Inhale 4 counts, hold 2, exhale 6.","REFLECT — Ask the room: 'Are we in a healthy or unhealthy stress response right now?'","CHOOSE — From this awareness, invite the team to choose how to proceed intentionally.","Use before difficult conversations, performance reviews, or highstakes decisions."], benefit:"A leader who models regulation gives the whole room permission to regulate. This is called coregulation — one of the most powerful leadership tools available." },
  { id:14, title:"The Wellness Framework — For Leaders", category:"Leadership · Foundation", duration:"15 minutes", type:"guide", desc:"Understanding the fourstage wellness framework helps leaders support their teams at every level.", steps:["STAGE 1 — AWARENESS: Your team's WellPulse data is stage one. Review it weekly.","STAGE 2 — REGULATION: Make regulation tools accessible and normalized. Model them yourself.","STAGE 3 — RESILIENCE BUILDING: Schedule group coaching sessions. Celebrate teams that recover well from difficulty.","STAGE 4 — MAINTENANCE: Sustain what works. Protect recovery time. Use WellPulse data to confirm what's working.","Ask yourself: Which stage is my team in right now?"], benefit:"Leaders who understand and actively support all four stages see the highest retention rates, the lowest burnout incidence, and the strongest team performance over time." },
...
*,*::before,*::after{boxsizing:borderbox;margin:0;padding:0;}
:root{
...
body{background:var(bg);fontfamily:'DM Sans',systemui,sansserif;color:var(ink);fontsize:14px;lineheight:1.5;}
::webkitscrollbar{width:5px;}
::webkitscrollbartrack{background:var(bg2);}
::webkitscrollbarthumb{background:var(borderS);borderradius:3px;}
.app{minheight:100vh;display:flex;flexdirection:column;}
.auth{minheight:100vh;display:flex;}
.authl{flex:1;background:var(ink);display:flex;alignitems:center;justifycontent:center;padding:64px;position:relative;overflow:hidden;}
.authl::before{content:'';position:absolute;inset:0;background:radialgradient(ellipse at 30% 50%,rgba(92,122,92,.25) 0%,transparent 60%),radialgradient(ellipse at 80% 80%,rgba(139,111,71,.15) 0%,transparent 50%);}
.authbrand{color:#fff;position:relative;zindex:1;}
.authlogo{fontfamily:'DM Serif Display',serif;fontsize:48px;color:#fff;letterspacing:1px;marginbottom:14px;}
.authtag{fontsize:16px;color:rgba(255,255,255,.6);maxwidth:300px;lineheight:1.7;fontweight:300;marginbottom:52px;}
.authfeats{display:flex;flexdirection:column;gap:18px;}
.authfeat{display:flex;alignitems:flexstart;gap:14px;}
.authfeatic{width:30px;height:30px;borderradius:7px;background:rgba(255,255,255,.08);display:flex;alignitems:center;justifycontent:center;flexshrink:0;}
.authfeattxt strong{display:block;color:rgba(255,255,255,.85);fontsize:13px;fontweight:500;marginbottom:2px;}
.authfeattxt span{color:rgba(255,255,255,.4);fontsize:12px;}
.authr{width:480px;background:var(surface);display:flex;alignitems:center;justifycontent:center;padding:56px 48px;}
.authcard{width:100%;}
.authtitle{fontfamily:'DM Serif Display',serif;fontsize:26px;marginbottom:4px;}
.authsub{color:var(faint);fontsize:13px;marginbottom:32px;fontweight:300;}
.authtabs{display:flex;background:var(bg2);borderradius:var(rl);padding:4px;gap:4px;marginbottom:28px;}
.authtab{flex:1;padding:8px;border:none;borderradius:7px;fontfamily:'DM Sans',sansserif;fontsize:13px;fontweight:500;cursor:pointer;background:transparent;color:var(soft);transition:all .2s;}
.authtab.on{background:var(surface);color:var(ink);boxshadow:var(sh);}
.field{marginbottom:15px;}
.field label{display:block;fontsize:11px;fontweight:600;color:var(soft);marginbottom:5px;texttransform:uppercase;letterspacing:.05em;}
.field input,.field select{width:100%;padding:9px 12px;border:1.5px solid var(border);borderradius:var(r);fontfamily:'DM Sans',sansserif;fontsize:14px;color:var(ink);background:var(surface2);outline:none;transition:all .15s;}
.field input:focus,.field select:focus{bordercolor:var(accent);background:var(surface);boxshadow:0 0 0 3px rgba(92,122,92,.1);}
.btn{width:100%;padding:11px 20px;background:var(accent);color:#fff;border:none;borderradius:var(r);fontfamily:'DM Sans',sansserif;fontsize:14px;fontweight:600;cursor:pointer;transition:background .15s;margintop:8px;}
.btn:hover{background:#4A6741;}.btn:disabled{opacity:.5;cursor:notallowed;}
.btnout{padding:8px 18px;background:transparent;color:var(accent);border:1.5px solid var(accent);borderradius:var(r);fontfamily:'DM Sans',sansserif;fontsize:13px;fontweight:500;cursor:pointer;}
.btnout:hover{background:var(alight);}
.btndk{padding:10px 20px;background:var(ink);color:#fff;border:none;borderradius:var(r);fontfamily:'DM Sans',sansserif;fontsize:13px;fontweight:600;cursor:pointer;display:inlineflex;alignitems:center;gap:8px;}
.btndk:hover{opacity:.88;}
.msgerr{background:var(dlight);color:var(danger);padding:9px 13px;borderradius:var(r);fontsize:13px;marginbottom:14px;borderleft:3px solid var(danger);}
.msgok{background:var(alight);color:var(accent);padding:9px 13px;borderradius:var(r);fontsize:13px;marginbottom:14px;borderleft:3px solid var(accent);}
.stabs{display:flex;gap:8px;marginbottom:14px;}
.stab{flex:1;padding:8px;border:1.5px solid var(border);borderradius:var(r);background:transparent;fontfamily:'DM Sans',sansserif;fontsize:13px;cursor:pointer;textalign:center;color:var(soft);transition:all .15s;}
.stab.on{background:var(accent);color:#fff;bordercolor:var(accent);fontweight:600;}
.nav{background:var(ink);height:50px;display:flex;alignitems:center;padding:0 22px;gap:14px;position:sticky;top:0;zindex:200;}
.navlogo{fontfamily:'DM Serif Display',serif;fontsize:21px;color:#fff;letterspacing:.5px;}
.navsep{width:1px;height:17px;background:rgba(255,255,255,.15);}
.navctx{fontsize:12px;color:rgba(255,255,255,.45);fontweight:300;}
.navr{marginleft:auto;display:flex;alignitems:center;gap:12px;}
.navcode{fontsize:11px;color:rgba(255,255,255,.35);letterspacing:.06em;}
.navcode strong{color:rgba(255,255,255,.65);letterspacing:.1em;}
.navav{width:28px;height:28px;borderradius:50%;background:var(accent);display:flex;alignitems:center;justifycontent:center;fontsize:11px;fontweight:700;color:#fff;}
.navnm{fontsize:12px;color:rgba(255,255,255,.6);}
.btnnav{padding:4px 12px;background:transparent;border:1px solid rgba(255,255,255,.2);borderradius:var(r);color:rgba(255,255,255,.6);fontfamily:'DM Sans',sansserif;fontsize:12px;cursor:pointer;}
.btnnav:hover{bordercolor:rgba(255,255,255,.4);color:#fff;}
.layout{display:flex;flex:1;minheight:0;}
.sb{width:200px;background:var(surface);borderright:1px solid var(border);padding:16px 0;flexshrink:0;}
.sbsec{fontsize:10px;fontweight:700;color:var(faint);texttransform:uppercase;letterspacing:.1em;padding:0 18px 6px;margintop:10px;}
.sbsec:firstchild{margintop:0;}
.sbitem{display:flex;alignitems:center;gap:9px;padding:8px 18px;fontsize:13px;color:var(soft);cursor:pointer;transition:all .1s;borderleft:2px solid transparent;}
.sbitem:hover{background:var(bg);color:var(ink);}
.sbitem.on{background:var(alight);color:var(accent);borderleftcolor:var(accent);fontweight:500;}
.sbic{width:16px;height:16px;flexshrink:0;opacity:.65;}
.sbitem.on .sbic{opacity:1;}
.content{flex:1;overflowy:auto;background:var(bg);}
.main{padding:28px 30px;maxwidth:1280px;}
.ph{marginbottom:22px;paddingbottom:18px;borderbottom:1px solid var(border);}
.phtitle{fontfamily:'DM Serif Display',serif;fontsize:25px;marginbottom:3px;}
.phsub{fontsize:13px;color:var(faint);fontweight:300;}
.crumb{fontsize:11px;color:var(faint);marginbottom:5px;}
.card{background:var(surface);border:1px solid var(border);borderradius:var(rl);padding:20px;boxshadow:var(sh);}
.card+.card{margintop:14px;}
.ct{fontsize:10px;fontweight:700;color:var(faint);texttransform:uppercase;letterspacing:.08em;marginbottom:14px;display:flex;alignitems:center;gap:10px;}
.ctline{flex:1;height:1px;background:var(border);}
.kgrid{display:grid;gridtemplatecolumns:repeat(4,1fr);gap:14px;marginbottom:18px;}
.kpi{background:var(surface);border:1px solid var(border);borderradius:var(rl);padding:18px 20px;boxshadow:var(sh);position:relative;overflow:hidden;}
...
.kpilb{fontsize:10px;fontweight:700;color:var(faint);texttransform:uppercase;letterspacing:.07em;marginbottom:8px;}
.kpiv{fontfamily:'DM Serif Display',serif;fontsize:36px;lineheight:1;marginbottom:4px;}
.kpiv small{fontfamily:'DM Sans',sansserif;fontsize:14px;fontweight:300;color:var(soft);}
.kpid{fontsize:11px;color:var(faint);}
.kpitr{fontsize:11px;fontweight:500;margintop:5px;}
.kpitr.pos{color:var(accent);}.kpitr.neg{color:var(danger);}
...
.tbl th{textalign:left;fontsize:10px;fontweight:700;color:var(faint);texttransform:uppercase;letterspacing:.07em;padding:8px 12px;borderbottom:1.5px solid var(border);background:var(surface2);}
.tbl td{padding:10px 12px;borderbottom:1px solid var(border);}
.tbl tr:lastchild td{borderbottom:none;}
.tbl tr:hover td{background:var(surface2);}
.badge{display:inlineflex;alignitems:center;gap:4px;padding:2px 8px;borderradius:20px;fontsize:11px;fontweight:600;}
.badgedot{width:5px;height:5px;borderradius:50%;background:currentColor;}
...
.sbarrow{display:flex;alignitems:center;gap:7px;}
.sbar{flex:1;height:5px;background:var(border);borderradius:3px;overflow:hidden;}
.sbarf{height:100%;borderradius:3px;}
.sbarv{fontsize:11px;fontweight:600;minwidth:22px;textalign:right;}
.ciwrap{maxwidth:560px;margin:0 auto;padding:36px 20px;}
.cicard{background:var(surface);border:1px solid var(border);borderradius:var(rxl);padding:36px;boxshadow:var(shm);}
.ciwk{fontsize:10px;fontweight:700;color:var(accent);texttransform:uppercase;letterspacing:.1em;marginbottom:5px;}
.cititle{fontfamily:'DM Serif Display',serif;fontsize:24px;marginbottom:4px;}
.cisub{fontsize:13px;color:var(faint);fontweight:300;marginbottom:28px;}
.ciprog{display:flex;gap:4px;marginbottom:28px;}
.cistep{flex:1;height:3px;background:var(border);borderradius:2px;transition:background .25s;}
.cistep.done{background:var(accent);}
.cistep.cur{background:var(accent);opacity:.4;}
.ciqn{fontsize:10px;fontweight:700;color:var(faint);texttransform:uppercase;letterspacing:.07em;marginbottom:8px;}
.ciq{fontsize:18px;fontweight:500;color:var(ink);marginbottom:6px;lineheight:1.4;}
.cihint{fontsize:13px;color:var(faint);fontweight:300;marginbottom:24px;}
.cisl{display:flex;alignitems:center;gap:10px;marginbottom:7px;}
.cisl input[type=range]{flex:1;webkitappearance:none;height:4px;background:var(border);borderradius:2px;outline:none;cursor:pointer;}
.cisl input[type=range]::webkitsliderthumb{webkitappearance:none;width:20px;height:20px;borderradius:50%;background:var(accent);cursor:pointer;boxshadow:0 1px 4px rgba(0,0,0,.2);border:2px solid #fff;}
.cisc{fontfamily:'DM Serif Display',serif;fontsize:38px;minwidth:44px;textalign:center;lineheight:1;}
.ciscl{display:flex;justifycontent:spacebetween;fontsize:11px;color:var(faint);marginbottom:28px;}
.cinav{display:flex;justifycontent:spacebetween;alignitems:center;}
.cidone{textalign:center;padding:36px 0;}
.cicheck{width:60px;height:60px;borderradius:50%;background:var(alight);display:flex;alignitems:center;justifycontent:center;margin:0 auto 18px;}
.cidone h2{fontfamily:'DM Serif Display',serif;fontsize:24px;marginbottom:8px;}
.cidone p{fontsize:14px;color:var(soft);lineheight:1.65;fontweight:300;}
.citip{margintop:22px;padding:13px 16px;background:var(surface2);border:1px solid var(border);borderradius:var(rl);fontsize:13px;color:var(soft);textalign:left;lineheight:1.5;}
.tgrid{display:grid;gridtemplatecolumns:repeat(autofill,minmax(290px,1fr));gap:14px;}
.tc{background:var(surface);border:1px solid var(border);borderradius:var(rl);padding:20px;cursor:pointer;transition:all .15s;}
.tc:hover{bordercolor:var(accent);boxshadow:var(shm);transform:translateY(1px);}
.tccat{fontsize:10px;fontweight:700;texttransform:uppercase;letterspacing:.1em;color:var(amber);marginbottom:7px;}
.tctitle{fontsize:15px;fontweight:600;marginbottom:5px;}
.tcdesc{fontsize:13px;color:var(soft);lineheight:1.55;marginbottom:13px;fontweight:300;}
.tcbenefit{fontsize:12px;color:var(accent);background:var(alight);borderradius:var(r);padding:8px 11px;margintop:10px;lineheight:1.45;display:none;}
.tc.exp .tcbenefit{display:block;}
.tcmeta{display:flex;alignitems:center;justifycontent:spacebetween;}
.tcdur{fontsize:12px;color:var(faint);}
.tcbtns{display:flex;gap:7px;}
.tcbtn{fontsize:12px;fontweight:600;padding:4px 11px;borderradius:20px;border:none;cursor:pointer;fontfamily:'DM Sans',sansserif;}
.tcbtn.why{background:var(surface2);color:var(soft);}
.tcbtn.open{background:var(alight);color:var(accent);}
.modalbg{position:fixed;inset:0;background:rgba(44,36,22,.5);display:flex;alignitems:center;justifycontent:center;zindex:500;padding:20px;backdropfilter:blur(2px);}
.modal{background:var(surface);borderradius:var(rxl);padding:34px;maxwidth:460px;width:100%;boxshadow:var(shl);maxheight:90vh;overflowy:auto;}
.mcat{fontsize:10px;fontweight:700;texttransform:uppercase;letterspacing:.1em;color:var(amber);marginbottom:7px;}
.mtitle{fontfamily:'DM Serif Display',serif;fontsize:22px;marginbottom:8px;}
.mdesc{fontsize:13px;color:var(soft);lineheight:1.6;marginbottom:20px;fontweight:300;}
.msteps{liststyle:none;marginbottom:18px;}
.mstep{display:flex;gap:11px;padding:9px 0;borderbottom:1px solid var(border);fontsize:13px;color:var(soft);lineheight:1.5;}
.mstep:lastchild{borderbottom:none;}
.mnum{width:20px;height:20px;borderradius:50%;background:var(accent);color:#fff;fontsize:10px;fontweight:700;display:flex;alignitems:center;justifycontent:center;flexshrink:0;margintop:2px;}
.mbenefit{background:var(alight);borderradius:var(r);padding:11px 13px;fontsize:13px;color:var(accent);lineheight:1.45;marginbottom:20px;}
.mbenefit strong{display:block;fontsize:10px;texttransform:uppercase;letterspacing:.07em;marginbottom:3px;opacity:.6;}
.mactions{display:flex;justifycontent:flexend;gap:9px;}
.brcircle{width:150px;height:150px;borderradius:50%;background:var(alight);border:2px solid var(accent);display:flex;alignitems:center;justifycontent:center;margin:22px auto;fontsize:14px;fontweight:500;color:var(accent);transition:transform 1s ease;}
.brcircle.in{transform:scale(1.28);}
.brcircle.out{transform:scale(1);}
.loading{display:flex;alignitems:center;justifycontent:center;minheight:100vh;flexdirection:column;gap:12px;background:var(bg);}
.spin{width:26px;height:26px;border:2px solid var(border);bordertopcolor:var(accent);borderradius:50%;animation:spin .85s linear infinite;}
@keyframes spin{to{transform:rotate(360deg);}}
.spinlb{fontsize:13px;color:var(faint);fontweight:300;}
.empty{textalign:center;padding:60px 20px;}
.emptyt{fontfamily:'DM Serif Display',serif;fontsize:20px;marginbottom:7px;}
.emptys{fontsize:13px;color:var(faint);fontweight:300;lineheight:1.6;}
@media(maxwidth:880px){
  .authl{display:none;}
  .authr{width:100%;padding:32px 24px;}
  .authcard{width:100%;}
  .authtitle{fontsize:22px;}
  .nav{padding:0 16px;height:48px;}
  .navlogo{fontsize:18px;}
  .navctx{display:none;}
  .navcode{display:none;}
  .navnm{display:none;}
  .navsep{display:none;}
  .layout{flexdirection:column;}
  .sb{display:none;}
  .content{width:100%;overflowx:hidden;}
  .main{padding:16px 14px;}
  .ph{marginbottom:16px;paddingbottom:14px;}
  .phtitle{fontsize:20px;}
  .phsub{fontsize:12px;}
  .kgrid{gridtemplatecolumns:1fr 1fr;gap:10px;marginbottom:14px;}
  .kpi{padding:14px;}
  .kpiv{fontsize:28px;}
  .g2,.g3{gridtemplatecolumns:1fr;}
  .tw{overflowx:auto;webkitoverflowscrolling:touch;}
  .tbl{minwidth:500px;}
  .tbl th,.tbl td{padding:8px 10px;fontsize:12px;}
  .ciwrap{padding:16px 12px;}
  .cicard{padding:24px 20px;borderradius:12px;}
  .cititle{fontsize:20px;}
  .ciq{fontsize:16px;}
  .cisc{fontsize:32px;}
  .tgrid{gridtemplatecolumns:1fr;}
  .tc{padding:16px;}
  .modalbg{padding:12px;}
  .modal{padding:24px 20px;maxheight:85vh;}
  .mtitle{fontsize:18px;}
  .card{padding:16px;}
...
.mobilenav{
  ...
  zindex:200;padding:0;boxshadow:0 2px 12px rgba(44,36,22,.08);
}
.mobilenavitem{
  flex:1;display:flex;flexdirection:column;alignitems:center;justifycontent:center;
  padding:8px 4px 10px;cursor:pointer;border:none;background:transparent;color:var(faint);
  fontfamily:'DM Sans',sansserif;fontsize:10px;fontweight:500;gap:4px;transition:color .15s;
}
.mobilenavitem.on{color:var(accent);}
.mobilenavitem svg{width:20px;height:20px;}
.mobilecontentpad{paddingbottom:70px;}
`;
...
export default function App() {
  ...
  if (loading) return <div className="loading"><div className="spin"/><div className="spinlb">Loading WellPulse</div></div>;
  if (!session) return <LandingOrAuth />;
  if (!profile) return <div className="loading"><div className="spin"/><div className="spinlb">Setting up your workspace</div></div>;
...
function AccessGate({ user, children }) {
  ...
  if (status === "loading") return <div className="loading"><div className="spin"/><div className="spinlb">Verifying access</div></div>;
  ...
  if (status === "paused") return (
    <div className="loading" style={{flexDirection:"column",gap:16,textAlign:"center",padding:40}}>
      ...
      <button style={{marginTop:8,padding:"10px 24px",background:"transparent",border:"1.5px solid var(border)",borderRadius:6,fontFamily:"'DM Sans',sansserif",fontSize:13,cursor:"pointer",color:"var(soft)"}} onClick={() => supabase.auth.signOut()}>Sign Out</button>
    </div>
  );
...
function SuperAdminApp({ user, onLogout }) {
  ...
  const nav = [
    { id:"companies", label:"All Companies", d:<><path d="M3 21h18M6 21V7a1 1 0 0111h10a1 1 0 011 1v14M9 21v4a1 1 0 0111h4a1 1 0 011 1v4"/></> },
    ...
    { id:"support", label:"Support Requests", d:<><path d="M20.84 4.61a5.5 5.5 0 007.78 0L12 5.67l1.061.06a5.5 5.5 0 007.78 7.78l1.06 1.06L12 21.23l7.787.78 1.061.06a5.5 5.5 0 0007.78z"/></> },
  ...
  return (
    <div className="app">
      <nav className="nav">
        <div className="navlogo">WellPulse</div>
        <div className="navsep"/>
        <div className="navctx">Owner Dashboard</div>
        ...
        <div className="navr">
          <div className="navav">{user.name?.[0]?.toUpperCase()}</div>
          <div className="navnm">{user.name}</div>
          <button className="btnnav" onClick={onLogout}>Sign out</button>
        </div>
      </nav>
      <div className="layout">
        <div className="sb">
          <div className="sbsec">Owner</div>
          {nav.map(item=>(
            <div key={item.id} className={"sbitem "+(page===item.id?"on":"")} onClick={()=>setPage(item.id)}>
              <svg className="sbic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">{item.d}</svg>
              {item.label}
            </div>
          ))}
        </div>
  ...
  return (
    <div className="main">
      <div className="ph">
        ...
        <div className="phtitle">All Companies</div>
        <div className="phsub">Every company currently using the WellPulse platform</div>
      </div>
      <div className="kgrid">
        <div className="kpi c1"><div className="kpilb">Companies</div><div className="kpiv">{totalCompanies}</div><div className="kpid">Active on platform</div></div>
        <div className="kpi c3"><div className="kpilb">Total Employees</div><div className="kpiv">{totalEmployees}</div><div className="kpid">Registered users</div></div>
        <div className="kpi c4"><div className="kpilb">Total CheckIns</div><div className="kpiv">{totalCheckins}</div><div className="kpid">Across all companies</div></div>
        <div className="kpi c1"><div className="kpilb">Avg Wellness Score</div><div className="kpiv" style={{color:getRiskColor(parseFloat(avgWellness))}}>{avgWellness}<small>/10</small></div><div className="kpid">Platformwide</div></div>
      </div>
      {companies.length === 0 ? (
        <div className="card"><div className="empty"><div className="emptyt">No companies yet</div><div className="emptys">Companies will appear here once they register.</div></div></div>
      ) : (
        <div className="card">
          <div className="ct">Company Overview <div className="ctline"/></div>
          <div className="tw">
            <table className="tbl">
              <thead><tr><th>Company Name</th><th>Code</th><th>Plan</th><th>Tier</th><th>Status</th><th>Employees</th><th>CheckIns</th><th>Wellness</th><th>Actions</th></tr></thead>
              <tbody>
                {companies.map(c => {
                    ...
                    <tr key={c.id}>
                      ...
                      <td>
                        <div style={{display:"flex",gap:5,flexWrap:"wrap"}}>
                          {c.status!=="active" && <button onClick={()=>updateStatus(c.code,"active","paid")} style={{fontSize:11,padding:"3px 8px",background:"var(alight)",color:"var(accent)",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>Activate</button>}
                          {c.status!=="trial" && <button onClick={()=>updateStatus(c.code,"trial","trial")} style={{fontSize:11,padding:"3px 8px",background:"var(wlight)",color:"var(warn)",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>Trial</button>}
                          {c.status!=="paused" && <button onClick={()=>updateStatus(c.code,"paused",c.plan)} style={{fontSize:11,padding:"3px 8px",background:"var(amlight)",color:"var(amber)",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>Pause</button>}
                          {c.status!=="cancelled" && <button onClick={()=>{ if(window.confirm("Cancel "+c.name+"?")) updateStatus(c.code,"cancelled",c.plan); }} style={{fontSize:11,padding:"3px 8px",background:"var(dlight)",color:"var(danger)",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>Cancel</button>}
                        </div>
                      </td>
                    </tr>
                  );
...
function SAActivityPage({ companies, totalCompanies, totalEmployees, totalCheckins, avgWellness }) {
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Platform Activity</div><div className="phtitle">Platform Activity</div><div className="phsub">Usage and engagement across all companies</div></div>
      <div className="card">
        <div className="ct">Company Wellness Comparison <div className="ctline"/></div>
        {companies.length === 0 ? <div className="empty"><div className="emptyt">No data yet</div></div> : (
          <ResponsiveContainer width="100%" height={280}>
            <BarChart data={companies.map(c=>({ name:c.name, Score:parseFloat(c.avg_wellness_score)||0, Employees:c.employee_count||0, CheckIns:c.total_checkins||0 }))} margin={{top:5,right:16,left:0,bottom:5}}>
              ...
              <Bar dataKey="CheckIns" fill="#7A8C6E" radius={[3,3,0,0]} name="CheckIns"/>
            </BarChart>
          </ResponsiveContainer>
        )}
      </div>
      <div className="card" style={{marginTop:14}}>
        <div className="ct">Platform Summary <div className="ctline"/></div>
        <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:20,padding:"8px 0"}}>
          {[["Total Companies",totalCompanies,"Organizations using WellPulse"],["Total Employees",totalEmployees,"Registered across all companies"],["Total CheckIns",totalCheckins,"Wellness surveys completed"],["Platform Avg Score",avgWellness+"/10","Overall wellness across platform"]].map(([label,val,desc])=>(
  ...
  return (
    <div className="main">
      <div className="ph">
        ...
        <div className="phtitle">High Risk Alerts</div>
        <div className="phsub">Companies scoring below 5/10 — your priority view before monthly calls</div>
      </div>

      <div className="kgrid" style={{gridTemplateColumns:"repeat(3,1fr)"}}>
        <div className="kpi c2">
          <div className="kpilb">High Risk Companies</div>
          <div className="kpiv" style={{color:"#A0522D"}}>{highRisk.length}</div>
          <div className="kpid">Scoring below 5/10</div>
        </div>
        <div className="kpi c3">
          <div className="kpilb">Pending Support Requests</div>
          <div className="kpiv" style={{color:"#C4956A"}}>{supportRequests.filter(r=>r.status==="pending").length}</div>
          <div className="kpid">Need followup</div>
        </div>
        <div className="kpi c1">
          <div className="kpilb">Total Companies</div>
          <div className="kpiv">{companies.length}</div>
          <div className="kpid">On platform</div>
        </div>
      </div>
      ...
      {highRisk.length === 0 ? (
        <div className="card" style={{marginBottom:14}}>
          <div className="empty">
            ...
            <div className="emptyt">No high risk companies</div>
            <div className="emptys">All companies with checkin data are scoring 5/10 or above. Keep monitoring.</div>
          </div>
        </div>
      ) : (
        <div className="card" style={{marginBottom:14,borderLeft:"4px solid var(danger)"}}>
          <div className="ct">Companies Requiring Immediate Attention <div className="ctline"/></div>
              ...
              return (
                <div key={c.id} style={{background:"var(dlight)",border:"1px solid #E8B4A0",borderRadius:"var(r)",padding:"14px 16px",display:"flex",alignItems:"center",gap:16}}>
                  ...
                  <a href={`mailto:Miranda@wildbloomwellnesshouse.com?subject=High Risk Alert — ${c.name}&body=Hi Miranda, ${c.name} (code: ${c.code}) is scoring ${score}/10. They may need a priority coaching call this month.`}
                    style={{fontSize:12,padding:"7px 14px",background:"var(danger)",color:"#fff",borderRadius:"var(r)",textDecoration:"none",fontWeight:600,fontFamily:"'DM Sans',sansserif",flexShrink:0}}>
                    Flag for Call
                  </a>
                </div>
              );
      ...
      {/* MONTHLY CALL PREP */}
      <div className="card">
        <div className="ct">Monthly Call Prep — All Companies <div className="ctline"/></div>
        ...
        <div style={{display:"grid",gridTemplateColumns:"repeat(autofill,minmax(260px,1fr))",gap:10}}>
          {companies.map(c => {
            const score = parseFloat(c.avg_wellness_score)||0;
            ...
            return (
              <div key={c.id} style={{background:"var(surface2)",border:`1px solid ${risk==="high"?"#E8B4A0":risk==="medium"?"#E8D5B7":"var(border)"}`,borderRadius:"var(r)",padding:"12px 14px",borderLeft:`3px solid ${score>0?getRiskColor(score):"var(border)"}`}}>
                ...
                {pending > 0 && (
                  <div style={{fontSize:11,fontWeight:600,color:"var(danger)",background:"var(dlight)",padding:"3px 8px",borderRadius:20,display:"inlineblock"}}>{pending} pending request{pending>1?"s":""}</div>
                )}
  ...
  return (
    <div className="main">
      <div className="ph">
        ...
        <div className="phtitle">Support Requests</div>
        <div className="phsub">Anonymous requests from employees who need coaching support</div>
      </div>
      <div className="kgrid" style={{gridTemplateColumns:"repeat(3,1fr)"}}>
        <div className="kpi c1"><div className="kpilb">Total Requests</div><div className="kpiv">{supportRequests.length}</div><div className="kpid">All time</div></div>
        <div className="kpi c2"><div className="kpilb">Pending</div><div className="kpiv" style={{color:"#C4956A"}}>{supportRequests.filter(r=>r.status==="pending").length}</div><div className="kpid">Need followup</div></div>
        <div className="kpi c4"><div className="kpilb">Resolved</div><div className="kpiv" style={{color:"#5C7A5C"}}>{supportRequests.filter(r=>r.status==="resolved").length}</div><div className="kpid">Completed</div></div>
      </div>
      {supportRequests.length === 0 ? (
        <div className="card"><div className="empty"><div className="emptyt">No support requests yet</div><div className="emptys">When employees request support, they will appear here anonymously.</div></div></div>
      ) : (
        <div className="card">
          <div className="ct">Anonymous Support Requests <div className="ctline"/></div>
          ...
          <table className="tbl">
            ...
            <tbody>
              {supportRequests.map(r=>(
                <tr key={r.id}>
                  <td style={{fontSize:12,color:"var(soft)"}}>{new Date(r.created_at).toLocaleDateString("enUS",{month:"short",day:"numeric",year:"numeric"})}</td>
                  ...
                  <td>
                    {r.status==="pending" && (
                      <button onClick={async()=>{ await supabase.from("support_requests").update({status:"resolved"}).eq("id",r.id); loadData(); }} style={{fontSize:11,padding:"3px 10px",background:"var(alight)",color:"var(accent)",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>Mark Resolved</button>
                    )}
                  </td>
                </tr>
              ))}
  ...
  return (
    <div className="main">
      <div className="ph">
        ...
        <div className="phtitle">Billing</div>
        <div className="phsub">Payment management and subscription overview</div>
      </div>

      <div className="kgrid">
        <div className="kpi c1">
          <div className="kpilb">Est. Monthly Revenue</div>
          <div className="kpiv" style={{fontSize:28}}>${totalMRR.toLocaleString()}</div>
          <div className="kpid">Active companies only</div>
        </div>
        <div className="kpi c1">
          <div className="kpilb">Active</div>
          <div className="kpiv" style={{color:"var(accent)"}}>{active.length}</div>
          <div className="kpid">Paying companies</div>
        </div>
        <div className="kpi c3">
          <div className="kpilb">Trial</div>
          <div className="kpiv" style={{color:"var(warn)"}}>{trial.length}</div>
          <div className="kpid">Free trial</div>
        </div>
        <div className="kpi c2">
          <div className="kpilb">Paused / Cancelled</div>
          <div className="kpiv" style={{color:"var(danger)"}}>{paused.length}</div>
          <div className="kpid">Inactive</div>
        </div>
      </div>

      <div className="card" style={{marginBottom:14}}>
        <div className="ct">Stripe Dashboard Links <div className="ctline"/></div>
        <div style={{display:"flex",gap:10}}>
          {[["Subscriptions","https://dashboard.stripe.com/subscriptions"],["Customers","https://dashboard.stripe.com/customers"],["Payments","https://dashboard.stripe.com/payments"]].map(([label,url])=>(
            <a key={label} href={url} target="_blank" rel="noreferrer" style={{padding:"8px 16px",background:"var(ink)",color:"#fff",borderRadius:"var(r)",textDecoration:"none",fontSize:12,fontWeight:600,fontFamily:"'DM Sans',sansserif",display:"flex",alignItems:"center",gap:6}}>
              <svg width="11" height="11" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round"><path d="M18 13v6a2 2 0 012 2H5a2 2 0 0122V8a2 2 0 0122h6"/><polyline points="15 3 21 3 21 9"/><line x1="10" y1="14" x2="21" y2="3"/></svg>
              {label}
            </a>
          ))}
        </div>
      ...
      <div className="card">
        <div className="ct">Company Billing Table <div className="ctline"/></div>
        {companies.length === 0 ? (
          <div className="empty"><div className="emptyt">No companies yet</div></div>
        ) : (
          <div className="tw">
            <table className="tbl">
              <thead>
                    ...
                    <tr key={c.id}>
                      ...
                      <td>
                        <div style={{display:"flex",gap:5}}>
                          {c.status!=="active" && <button onClick={()=>updateStatus(c.code,"active","paid")} style={{fontSize:11,padding:"3px 9px",background:"var(alight)",color:"var(accent)",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>Activate</button>}
                          {c.status!=="paused" && c.status!=="cancelled" && <button onClick={()=>updateStatus(c.code,"paused",c.plan)} style={{fontSize:11,padding:"3px 9px",background:"var(amlight)",color:"var(amber)",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>Pause</button>}
                        </div>
                      </td>
                    </tr>
                  );
  ...
  return (
    <div className="main">
      <div className="ph">
        ...
        <div className="phtitle">Pricing Tiers</div>
        <div className="phsub">Three tiers + addons — manage company access and communicate your value</div>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:14,marginBottom:16}}>
        <div className="card" style={{border:"1.5px solid var(border)"}}>
          ...
          {["Realtime burnout risk analytics","Anonymous employee checkins","Team and department dashboards","Monthly executive summary reports","Trend tracking — energy, stress, engagement"].map(f=>(
            <div key={f} style={{display:"flex",gap:9,alignItems:"flexstart",marginBottom:8}}>
        ...
        <div className="card" style={{border:"2px solid var(amber)",position:"relative"}}>
          ...
          {["Monthly group coaching sessions","Nervous system and stress regulation training","Burnout education workshops","Teambased performance insights"].map(f=>(
            <div key={f} style={{display:"flex",gap:9,alignItems:"flexstart",marginBottom:8}}>
        ...
        <div className="card" style={{border:"2px solid var(ink)",position:"relative"}}>
          ...
          {["Leadership consulting and strategy calls","1on1 confidential coaching","Employees can request support anonymously","Custom burnout recovery plans","Priority support and implementation guidance"].map(f=>(
            <div key={f} style={{display:"flex",gap:9,alignItems:"flexstart",marginBottom:8}}>
              <svg style={{flexShrink:0,marginTop:2}} width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#5C7A5C" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
      ...
      <div className="card">
        <div className="ct">Current Company Tiers <div className="ctline"/></div>
        <table className="tbl">
                  ...
                  <td>
                    <div style={{display:"flex",gap:6}}>
                      {[["insights","Insight","var(accent)"],["optimize","Optimize","var(amber)"],["transform","Transform","var(ink)"]].map(([t,label,col])=>(
                        <button key={t} onClick={()=>updateTier(c.code,t)} style={{fontSize:11,padding:"3px 10px",background:c.tier===t?col:"var(surface2)",color:c.tier===t?"#fff":"var(soft)",border:`1px solid ${c.tier===t?col:"var(border)"}`,borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif"}}>{label}</button>
                      ))}
                    </div>
                  </td>
                </tr>
...
function LandingPage({ onSignIn }) {
  ...
  return (
    <div style={{fontFamily:"'DM Sans',sansserif",background:"#F5F0EA",minHeight:"100vh",color:"#1E1A14"}}>

      {/* NAV */}
      <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:100,padding:"14px 24px",display:"flex",alignItems:"center",justifyContent:"spacebetween",background:"rgba(245,240,234,0.96)",backdropFilter:"blur(12px)",borderBottom:"1px solid #E2D9CE"}}>
        <div style={{fontFamily:"'DM Serif Display',serif",fontSize:20,color:"#1E1A14",flexShrink:0}}>WellPulse<span style={{display:"inlineblock",width:6,height:6,borderRadius:"50%",background:"#4A6741",marginLeft:3,verticalAlign:"middle",marginBottom:3}}/></div>
        <div style={{display:"flex",gap:12,alignItems:"center"}}>
          <a href="#how" style={{fontSize:13,color:"#6B5D4F",textDecoration:"none",whiteSpace:"nowrap",display:"none"}} className="navdesktop">How It Works</a>
          <a href="#coaching" style={{fontSize:13,color:"#6B5D4F",textDecoration:"none",whiteSpace:"nowrap",display:"none"}} className="navdesktop">Coaching</a>
          <a href="#who" style={{fontSize:13,color:"#6B5D4F",textDecoration:"none",whiteSpace:"nowrap",display:"none"}} className="navdesktop">Who It's For</a>
          <button onClick={onSignIn} style={{padding:"8px 18px",background:"#1E1A14",color:"#fff",border:"none",borderRadius:4,fontFamily:"'DM Sans',sansserif",fontSize:13,fontWeight:600,cursor:"pointer",whiteSpace:"nowrap"}}>Sign In</button>
        </div>
      </nav>
      <style>{`@media(minwidth:600px){.navdesktop{display:block !important;}} @media(maxwidth:599px){.lpmockup{display:none !important;} .lphero{gridtemplatecolumns:1fr !important;padding:100px 24px 60px !important;} .lpstats{gridtemplatecolumns:1fr 1fr !important;} .lpstat{borderright:none !important;borderbottom:1px solid rgba(255,255,255,0.07);} .lphow{padding:60px 24px !important;} .lphowgrid{gridtemplatecolumns:1fr !important; gap:32px !important;} .lpwho{padding:60px 24px !important;} .lpburnoutgrid{gridtemplatecolumns:1fr 1fr !important;} .lproles{gridtemplatecolumns:1fr !important;} .lpcoaching{padding:60px 24px !important;} .lpcoachinggrid{gridtemplatecolumns:1fr !important; gap:40px !important;} .lpquote{padding:48px 24px !important;} .lpdemo{padding:60px 24px !important;} .lpdemoform{padding:28px 20px !important;} .lpdemofields{gridtemplatecolumns:1fr !important;} .lpfooter{padding:40px 24px !important; flexdirection:column !important; gap:20px !important; textalign:center !important;} .lpfooterlinks{display:none !important;}}`}</style>

      {/* HERO */}
      <div style={{minHeight:"100vh",background:"#1E1A14",display:"flex",alignItems:"center",position:"relative",overflow:"hidden"}}>
        <div style={{position:"absolute",top:200,right:200,width:600,height:600,borderRadius:"50%",background:"radialgradient(circle,rgba(74,103,65,0.2) 0%,transparent 70%)",pointerEvents:"none"}}/>
        <div className="lphero" style={{maxWidth:1200,margin:"0 auto",width:"100%",display:"grid",gridTemplateColumns:"1fr 1fr",gap:60,alignItems:"center",position:"relative",zIndex:1,padding:"140px 48px 80px"}}>
          <div>
            <div style={{display:"inlineflex",alignItems:"center",gap:8,fontSize:11,fontWeight:700,textTransform:"uppercase",letterSpacing:".12em",color:"rgba(253,252,249,0.8)",marginBottom:24,padding:"6px 14px",background:"rgba(255,255,255,0.08)",borderRadius:20,border:"1px solid rgba(255,255,255,0.15)"}}>
            ...
            <p style={{fontSize:16,color:"rgba(253,252,249,0.6)",fontWeight:300,lineHeight:1.75,marginBottom:36,maxWidth:480}}>WellPulse gives leadership teams realtime visibility into workforce wellness — and connects them with certified coaching to act on what the data shows.</p>
            ...
            <div style={{marginTop:32,display:"flex",alignItems:"center",gap:16,fontSize:12,color:"rgba(253,252,249,0.35)",flexWrap:"wrap"}}>
              <span>Anonymous checkins</span><span style={{width:3,height:3,borderRadius:"50%",background:"rgba(253,252,249,0.2)"}}/>
              <span>Departmentlevel data</span><span style={{width:3,height:3,borderRadius:"50%",background:"rgba(253,252,249,0.2)"}}/>
              <span>Wild Bloom coaching</span>
            </div>
          </div>
          {/* Dashboard mockup — hidden on mobile */}
          <div className="lpmockup" style={{background:"#FDFCF9",border:"1px solid #E2D9CE",borderRadius:12,overflow:"hidden",boxShadow:"0 20px 60px rgba(0,0,0,0.4)"}}>
      ...
      <div style={{background:"#1E1A14",padding:"48px 24px"}}>
        <div className="lpstats" style={{maxWidth:1200,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(4,1fr)"}}>
          {[["$1T","Lost annually to workplace stress globally"],["68%","Of employees are disengaged at work right now — Gallup"],["15%","Of global GDP lost to presenteeism from poor mental health — WHO"],["2min","To complete a WellPulse checkin"]].map(([n,l],i)=>(
            <div className="lpstat" key={n} style={{textAlign:"center",padding:"20px 16px",borderRight:"1px solid rgba(255,255,255,0.07)"}}>
      ...
      {/* HOW IT WORKS */}
      <div id="how" className="lphow" style={{background:"#F5F0EA",padding:"80px 48px"}}>
        <div style={{maxWidth:1200,margin:"0 auto"}}>
          ...
          <div className="lphowgrid" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:60,alignItems:"center"}}>
            <div>
                                {[["Employees check in weekly","A 5question anonymous survey. Stress, workload, relationships, manager support, balance. 2 minutes. No names. No pressure."],
                ["Leadership sees the data","Realtime department scores, burnout risk levels, weekoverweek trends, and participation rates. Aggregated, never individual."],
            ...
            <div style={{background:"#FDFCF9",border:"1px solid #E2D9CE",borderRadius:12,padding:28,boxShadow:"0 4px 24px rgba(30,26,20,0.08)"}}>
              ...
              <div style={{display:"flex",justifyContent:"spacebetween",fontSize:10,color:"#B0A090",marginBottom:16}}><span>Overwhelmed</span><span>Very manageable</span></div>
      ...
      {/* WHO IT'S FOR */}
      <div id="who" className="lpwho" style={{background:"#FDFCF9",padding:"80px 48px",borderTop:"1px solid #E2D9CE",borderBottom:"1px solid #E2D9CE"}}>
        <div style={{maxWidth:1200,margin:"0 auto"}}>
          ...
          <p style={{fontSize:15,color:"#6B5D4F",fontWeight:300,lineHeight:1.75,maxWidth:680,marginBottom:44}}>WellPulse is the proactive approach. Realtime wellness data that turns invisible risk into visible, actionable insight — so you can lead your people before the problem leads you.</p>
          <div className="lpburnoutgrid" style={{display:"grid",gridTemplateColumns:"repeat(4,1fr)",gap:2,background:"#E2D9CE",borderRadius:12,overflow:"hidden",marginBottom:44}}>
            {[["77%","of employees have experienced burnout at their current job — Deloitte"],["2.6×","more likely to leave their employer when burned out — Gallup"],["$322B","lost globally each year to burnoutrelated turnover — WHO"],["89%","of workers at companies with wellbeing programs recommend their employer — APA"]].map(([n,l])=>(
          ...
          <div className="lproles" style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:2,background:"#E2D9CE",borderRadius:12,overflow:"hidden"}}>
              ...
              ["CEOs & Founders","Culture is no longer a soft metric. It is a retention strategy, a performance strategy, and a recruiting advantage. WellPulse keeps a realtime pulse on it so you can lead with confidence, not guesswork."],
              ...
              <div key={t} style={{background:"#FDFCF9",padding:"28px 24px"}}>
                <div style={{width:38,height:38,borderRadius:9,background:"#EEF3EE",display:"flex",alignItems:"center",justifyContent:"center",marginBottom:12}}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="#4A6741" strokeWidth="1.5" strokeLinecap="round"><path d="M17 21v2a4 4 0 0044H5a4 4 0 004 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                </div>
      ...
      {/* WILD BLOOM COACHING */}
      <div id="coaching" className="lpcoaching" style={{background:"#2C3D28",padding:"80px 48px"}}>
        <div className="lpcoachinggrid" style={{maxWidth:1200,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:60,alignItems:"center"}}>
          <div>
            ...
            <div style={{display:"flex",flexDirection:"column",gap:10,marginBottom:28}}>
              {[["50%","of burnedout employees would leave for a company that better supports wellbeing — McKinsey"],["74%","reduction in stress in psychologically safe teams — APA"],["4×","more likely to stay at a company where they feel psychologically safe — Gallup"]].map(([n,l])=>(
            ...
            <a href="#demo" style={{padding:"12px 26px",background:"#C4956A",color:"#fff",borderRadius:4,textDecoration:"none",fontSize:14,fontWeight:600,display:"inlineblock"}}>Book a Coaching Consultation</a>
          </div>
          <div style={{display:"flex",flexDirection:"column",gap:10}}>
              ...
              ["Nervous System Regulation","Sciencebacked practices embedded into your workplace culture. Not onetime events."],
              ["1on1 Confidential Coaching","For highrisk employees and leaders. Fully confidential. Requested anonymously through the platform."],
              ["Leadership Intensives","Offsite retreats for senior teams. Available locally, nationally, and internationally."]
            ].map(([t,d])=>(
              <div key={t} style={{display:"flex",gap:12,alignItems:"flexstart",padding:16,background:"rgba(255,255,255,0.05)",borderRadius:8,border:"1px solid rgba(255,255,255,0.07)"}}>
                <div style={{width:30,height:30,borderRadius:7,background:"rgba(255,255,255,0.07)",display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}}>
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(253,252,249,0.6)" strokeWidth="1.5"><path d="M20.84 4.61a5.5 5.5 0 007.78 0L12 5.67l1.061.06a5.5 5.5 0 007.78 7.78l1.06 1.06L12 21.23l7.787.78 1.061.06a5.5 5.5 0 0007.78z"/></svg>
                </div>
                <div>
      ...
      {/* QUOTE */}
      <div className="lpquote" style={{background:"#C4956A",padding:"60px 48px",textAlign:"center"}}>
      ...
      {/* DEMO FORM */}
      <div id="demo" className="lpdemo" style={{background:"#F5F0EA",padding:"80px 48px",textAlign:"center"}}>
        ...
        <div className="lpdemoform" style={{background:"#FDFCF9",border:"1px solid #E2D9CE",borderRadius:12,padding:36,maxWidth:520,margin:"0 auto",boxShadow:"0 4px 32px rgba(30,26,20,0.1)",textAlign:"left"}}>
          {submitted ? (
            ...
            <>
              ...
              <div className="lpdemofields" style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:10,marginBottom:10}}>
                {[["First Name","firstName","text","Jane"],["Last Name","lastName","text","Smith"],["Work Email","email","email","jane@company.com"],["Company","company","text","Acme Corp"]].map(([l,k,t,p])=>(
                  <div key={k}>
                    ...
                    <input type={t} value={formData[k]} onChange={e=>setFormData({...formData,[k]:e.target.value})} placeholder={p} style={{width:"100%",padding:"9px 12px",border:"1.5px solid #E2D9CE",borderRadius:4,fontFamily:"'DM Sans',sansserif",fontSize:14,color:"#1E1A14",background:"#F5F0EA",outline:"none"}}/>
                  </div>
                ))}
              </div>
              <div style={{marginBottom:14}}>
                ...
                <textarea value={formData.challenge} onChange={e=>setFormData({...formData,challenge:e.target.value})} placeholder="e.g. High turnover and we don't know why..." style={{width:"100%",padding:"10px 12px",border:"1.5px solid #E2D9CE",borderRadius:4,fontFamily:"'DM Sans',sansserif",fontSize:14,color:"#1E1A14",background:"#F5F0EA",outline:"none",resize:"vertical",minHeight:68,lineHeight:1.5}}/>
              </div>
              <button onClick={handleDemo} disabled={sending} style={{width:"100%",padding:13,background:"#1E1A14",color:"#fff",border:"none",borderRadius:4,fontFamily:"'DM Sans',sansserif",fontSize:15,fontWeight:600,cursor:"pointer"}}>{sending?"Sending...":"Request My Demo →"}</button>
      ...
      {/* FOOTER */}
      <footer className="lpfooter" style={{background:"#1E1A14",padding:"48px 48px",display:"flex",alignItems:"center",justifyContent:"spacebetween"}}>
        <div>
        ...
        <div className="lpfooterlinks" style={{display:"flex",gap:24,alignItems:"center"}}>
          ...
          <button onClick={onSignIn} style={{fontSize:13,color:"rgba(255,255,255,0.35)",background:"none",border:"none",cursor:"pointer",fontFamily:"'DM Sans',sansserif"}}>Sign In</button>
        </div>
      </footer>
    </div>
  );
    ...
    <div className="auth">
      <div className="authl">
        <div className="authbrand">
          <div className="authlogo">WellPulse</div>
          <div className="authtag">Workplace wellness intelligence for teams that care about their people.</div>
          <div className="authfeats">
            {[["Burnout Risk Tracking","Realtime departmentlevel monitoring"],["Weekly CheckIns","Fivequestion pulse surveys. Two minutes."],["Prevention Toolkit","Evidencebased stress and clarity tools"],["Trend Reporting","Weekly and monthly wellness analytics"]].map(([t,s])=>(
              <div className="authfeat" key={t}>
                <div className="authfeatic"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,.5)" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg></div>
                <div className="authfeattxt"><strong>{t}</strong><span>{s}</span></div>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="authr">
        <div className="authcard">
          ...
          <div className="authsub">Sign in to your WellPulse workspace</div>
          <div className="authtabs">
            <button className={`authtab ${tab==="login"?"on":""}`} onClick={()=>{setTab("login");setError("");setMsg("");}}>Sign In</button>
            <button className={`authtab ${tab==="reg"?"on":""}`} onClick={()=>{setTab("reg");setError("");setMsg("");}}>Register</button>
          </div>
...
function LeadershipApp({ user, onLogout }) {
  ...
  const analyticsNav = [
    ...
    { id:"departments", label:"Departments", d:<><path d="M3 21h18M6 21V7a1 1 0 0111h10a1 1 0 011 1v14M9 21v4a1 1 0 0111h4a1 1 0 011 1v4"/></> },
    { id:"trends", label:"Trends", d:<><polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/></> },
    { id:"reports", label:"Reports", d:<><path d="M14 2H6a2 2 0 002 2v16a2 2 0 002 2h12a2 2 0 0022V8z"/><polyline points="14 2 14 8 20 8"/></> },
    { id:"actions", label:"Action Center", d:<><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="12"/><line x1="12" y1="16" x2="12.01" y2="16"/></> },
  ];
  const toolsNav = [
    { id:"stress", label:"Stress Management", d:<><path d="M17 8C8 10 5.9 16.17 3.82 19.34c.2.3.1.66.44.55C5.77 19.26 8.15 18.31 10 17"/><path d="M14 2s1 2 1 42 42 4"/></> },
    { id:"neuro", label:"Team Practices", d:<><path d="M12 5a3 3 0 105.997.125 4 4 0 002.526 5.77 4 4 0 00.556 6.588A4 4 0 1012 18"/><path d="M12 5a3 3 0 115.997.125 4 4 0 012.526 5.77 4 4 0 01.556 6.588A4 4 0 1112 18"/></> },
    { id:"resources", label:"Resources Library", d:<><path d="M4 19.5A2.5 2.5 0 016.5 17H20"/><path d="M6.5 2H20v20H6.5A2.5 2.5 0 014 19.5v15A2.5 2.5 0 016.5 2z"/></> },
  ];
  const coachingNav = [
    { id:"coaching", label:"Coaching Hub", d:<><path d="M17 21v2a4 4 0 0044H5a4 4 0 004 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v2a4 4 0 0033.87M16 3.13a4 4 0 010 7.75"/></> },
    { id:"schedule", label:"Monthly CheckIns", d:<><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></> },
  ];
  const companyNav = [
    { id:"company", label:"Company Settings", d:<><path d="M12 22s84 810V5l838 3v7c0 6 8 10 8 10z"/></> },
  ];
  ...
  return (
    <div className="app">
      <nav className="nav">
        <div className="navlogo">WellPulse</div>
        <div className="navsep"/>
        <div className="navctx">Leadership Portal</div>
        <div className="navr">
          {user.company_code && <div className="navcode">Company Code <strong>{user.company_code}</strong></div>}
          <div className="navav">{user.name?.[0]?.toUpperCase()}</div>
          <div className="navnm">{user.name}</div>
          <button className="btnnav" onClick={onLogout}>Sign out</button>
        </div>
      ...
      <div className="layout">
        <div className="sb" style={{display:"flex",flexDirection:"column"}}>
          <div style={{flex:1}}>
            <div className="sbsec">Analytics</div>
            {analyticsNav.map(item=>(<div key={item.id} className={"sbitem "+(page===item.id?"on":"")} onClick={()=>setPage(item.id)}><svg className="sbic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">{item.d}</svg>{item.label}</div>))}
            <div className="sbsec">Wellness Tools</div>
            {toolsNav.map(item=>(<div key={item.id} className={"sbitem "+(page===item.id?"on":"")} onClick={()=>setPage(item.id)}><svg className="sbic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">{item.d}</svg>{item.label}</div>))}
            <div className="sbsec">Wild Bloom Coaching</div>
            {coachingNav.map(item=>(<div key={item.id} className={"sbitem "+(page===item.id?"on":"")} onClick={()=>setPage(item.id)}><svg className="sbic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">{item.d}</svg>{item.label}</div>))}
            <div className="sbsec">Workspace</div>
            {companyNav.map(item=>(<div key={item.id} className={"sbitem "+(page===item.id?"on":"")} onClick={()=>setPage(item.id)}><svg className="sbic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">{item.d}</svg>{item.label}</div>))}
          </div>
        ...
        <div className="content">
          {loading ? <div className="loading"><div className="spin"/></div> : (
            <>
              ...
              {page==="stress" && <ToolkitPage tools={STRESS_TOOLS} title="Stress Management" subtitle="Evidencebased techniques to share with your team"/>}
...
function DashPage({ checkins, user }) {
  ...
  }).filter(Boolean).sort((a,b)=>a.scoreb.score);
  ...
  return (
    <div className="main">
      <div className="ph">
        ...
        <div className="phtitle">Wellness Overview</div>
        <div className="phsub">{cw||"No data yet"} &nbsp;·&nbsp; {depts.length} departments &nbsp;·&nbsp; {tw.length} responses this week</div>
      </div>
      {alerts.length > 0 && (
        <div style={{marginBottom:16,display:"flex",flexDirection:"column",gap:8}}>
          {alerts.map(a=>(
            <div key={a.dept} style={{background:"var(dlight)",border:"1px solid #E8B4A0",borderRadius:"var(r)",padding:"10px 16px",display:"flex",alignItems:"center",gap:12}}>
              ...
              }} style={{marginLeft:"auto",fontSize:11,padding:"4px 12px",background:"var(danger)",color:"#fff",border:"none",borderRadius:20,cursor:"pointer",fontWeight:600,fontFamily:"'DM Sans',sansserif",flexShrink:0}}>Alert Miranda</button>
            </div>
          ))}
        </div>
      )}
      <div className="kgrid">
        <div className="kpi c1">
          <div className="kpilb">Overall Score</div>
          <div className="kpiv" style={{color:getRiskColor(overall)}}>{overall}<small>/10</small></div>
          <div className="kpid">{getRiskLabel(overall)}</div>
          {trend!==0 && <div className={`kpitr ${trend>0?"pos":"neg"}`}>{trend>0?"↑":"↓"} {Math.abs(trend)} vs last week</div>}
        </div>
        <div className="kpi c2">
          <div className="kpilb">High Risk Depts</div>
          <div className="kpiv" style={{color:high>0?"#A0522D":"#5C7A5C"}}>{high}</div>
          <div className="kpid">Require attention</div>
        </div>
        <div className="kpi c3">
          <div className="kpilb">Participation</div>
          <div className="kpiv" style={{color:participationRate&&participationRate<50?"#A0522D":participationRate&&participationRate<75?"#C4956A":"#5C7A5C"}}>{participationRate!==null?participationRate+"%":tw.length}</div>
          <div className="kpid">{participationRate!==null?tw.length+" of "+teamSize+" employees":"responses this week"}</div>
        </div>
        <div className="kpi c4">
          <div className="kpilb">Departments</div>
          <div className="kpiv">{depts.length}</div>
          <div className="kpid">Being tracked</div>
        </div>
      </div>
      {checkins.length===0 ? (
        <div className="card"><div className="empty"><div className="emptyt">No data yet</div><div className="emptys">Share your company code <strong>{user.company_code}</strong> with employees so they can register and complete their weekly checkins.</div></div></div>
      ) : (
        <>
          <div className="card" style={{marginBottom:16}}>
            <div className="ct">Department Ranking — Healthiest to Most At Risk <div className="ctline"/></div>
            <div style={{display:"flex",flexDirection:"column",gap:10}}>
              {[...ds].sort((a,b)=>b.scorea.score).map((d,i)=>(
                <div key={d.dept} style={{display:"flex",alignItems:"center",gap:12}}>
                  <div style={{width:22,height:22,borderRadius:"50%",background:i===0?"var(alight)":i===ds.length1&&getRisk(d.score)==="high"?"var(dlight)":"var(surface2)",display:"flex",alignItems:"center",justifyContent:"center",fontSize:11,fontWeight:700,color:i===0?"var(accent)":i===ds.length1&&getRisk(d.score)==="high"?"var(danger)":"var(faint)",flexShrink:0}}>{i+1}</div>
                  ...
                  <span className={"badge "+getRisk(d.score)} style={{minWidth:90,justifyContent:"center"}}><span className="badgedot"/>{getRiskLabel(d.score)}</span>
          ...
          <div className="g2">
            <div className="card">
              <div className="ct">Wellness by Category <div className="ctline"/></div>
            ...
            <div className="card">
              <div className="ct">Risk Distribution <div className="ctline"/></div>
              {pie.length>0 ? (
                <ResponsiveContainer width="100%" height={210}>
                  <PieChart>
              ...
              ) : <div className="empty" style={{padding:"30px 0"}}><div className="emptys">Insufficient data</div></div>}
            </div>
          </div>
          <div className="card">
            <div className="ct">Department Risk Overview <div className="ctline"/></div>
            <div className="tw">
              <table className="tbl">
                ...
                <tbody>
                  {ds.map(d=>(
                    <tr key={d.dept}>
                      ...
                      <td><span className={`badge ${getRisk(d.score)}`}><span className="badgedot"/>{getRiskLabel(d.score)}</span></td>
                      <td><div className="sbarrow"><div className="sbar"><div className="sbarf" style={{width:`${d.score*10}%`,background:getRiskColor(d.score)}}/></div><span className="sbarv" style={{color:getRiskColor(d.score)}}>{d.score}</span></div></td>
...
function DeptsPage({ checkins }) {
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Departments</div><div className="phtitle">Department Analysis</div><div className="phsub">Wellness category scores by department — {cw}</div></div>
      {bar.length===0 ? <div className="card"><div className="empty"><div className="emptyt">No department data yet</div></div></div> : (
        <>
          <div className="card" style={{marginBottom:14}}>
            <div className="ct">All Categories by Department <div className="ctline"/></div>
          ...
          <div className="g2">
            {bar.slice(0,4).map((d,i)=>(
              <div key={d.dept} className="card">
                <div className="ct">{d.dept} <div className="ctline"/></div>
                {["Stress","Workload","Relationships","Manager","Balance"].map(cat=>(
                  <div key={cat} style={{marginBottom:9}}>
                    <div style={{display:"flex",justifyContent:"spacebetween",fontSize:12,marginBottom:3}}><span style={{color:"var(soft)"}}>{cat}</span><span style={{fontWeight:600}}>{d[cat]}/10</span></div>
                    <div className="sbar" style={{height:5}}><div className="sbarf" style={{width:`${d[cat]*10}%`,background:COLORS[i%COLORS.length]}}/></div>
                  </div>
                ))}
              </div>
            ))}
...
function TrendsPage({ checkins }) {
  ...
  const monthly = (()=>{
    const m = {};
    checkins.forEach(c=>{
      const key = c.created_at ? new Date(c.created_at).toLocaleString("default",{month:"short",year:"2digit"}) : "N/A";
      if (!m[key]) m[key]=[];
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Trends</div><div className="phtitle">Wellness Trends</div><div className="phsub">Weekly and monthly performance over time</div></div>
      <div className="card" style={{marginBottom:14}}>
        <div className="ct">Overall Weekly Trend <div className="ctline"/></div>
      ...
      <div className="g2">
        <div className="card">
          <div className="ct">Department Trends <div className="ctline"/></div>
          <ResponsiveContainer width="100%" height={210}>
            <LineChart data={wt}>
              <CartesianGrid strokeDasharray="3 3" stroke="#E2D9CE" vertical={false}/>
        ...
        <div className="card">
          <div className="ct">Category Trends <div className="ctline"/></div>
          <ResponsiveContainer width="100%" height={210}>
            <LineChart data={ct}>
              <CartesianGrid strokeDasharray="3 3" stroke="#E2D9CE" vertical={false}/>
              <XAxis dataKey="week" tick={{fontSize:10,fill:"#6B5D4F"}}/><YAxis domain={[1,10]} tick={{fontSize:10,fill:"#6B5D4F"}}/>
...
function ReportsPage({ checkins, user }) {
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Reports</div><div className="phtitle">Wellness Reports</div><div className="phsub">Export and review detailed reports for leadership review</div></div>
      <div className="card" style={{marginBottom:14}}>
        <div className="ct">Export Report <div className="ctline"/></div>
        ...
        <button className="btndk" onClick={exportReport}>
          <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M21 15v4a2 2 0 012 2H5a2 2 0 0122v4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg>
          Export Report
        </button>
      </div>
      <div className="card">
        <div className="ct">Report Preview — {cw||"No data"} <div className="ctline"/></div>
        {ds.length===0 ? <div className="empty"><div className="emptyt">No data to report</div></div> : (
          <table className="tbl">
...
function CompanyPage({ user }) {
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Company Settings</div><div className="phtitle">Company Settings</div><div className="phsub">Manage your workspace and employee access</div></div>
      <div className="card" style={{marginBottom:14}}>
        <div className="ct">Subscription <div className="ctline"/></div>
        {companyInfo && (
        ...
        <div style={{background:"var(surface2)",border:"1px solid var(border)",borderRadius:"var(r)",padding:"16px",marginBottom:14}}>
          ...
          <div style={{display:"flex",gap:10,alignItems:"center",marginBottom:14}}>
            <input type="number" value={seats} onChange={e=>setSeats(e.target.value)} placeholder="e.g. 150" min="1" style={{width:100,padding:"8px 12px",border:"1.5px solid var(border)",borderRadius:"var(r)",fontFamily:"'DM Sans',sansserif",fontSize:14,color:"var(ink)",background:"var(surface)",outline:"none"}}/>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr",gap:10}}>
            {[["insights","Insight","$8/employee","var(alight)","var(accent)"],["optimize","Optimize","$22/employee","var(wlight)","var(amber)"],["transform","Transform","$44/employee","var(surface2)","var(ink)"]].map(([tier,label,price,bg,color])=>(
              <div key={tier} style={{background:bg,border:"1px solid var(border)",borderRadius:"var(r)",padding:"12px",textAlign:"center"}}>
                ...
                <button onClick={()=>startCheckout(tier)} disabled={checkingOut===tier} style={{width:"100%",padding:"7px",background:color,color:"#fff",border:"none",borderRadius:"var(r)",fontFamily:"'DM Sans',sansserif",fontSize:12,fontWeight:600,cursor:"pointer"}}>{checkingOut===tier?"Redirecting...":"Subscribe"}</button>
              </div>
            ))}
          </div>
        </div>
      ...
      <div className="card" style={{marginBottom:14}}>
        <div className="ct">Your Company Access Code <div className="ctline"/></div>
...
function ActionCenterPage({ checkins, user }) {
  ...
  const actions = [
    ...high.map(d=>({ priority:"urgent", dept:d.dept, score:d.score, title:`${d.dept} is at High Risk`, desc:`With a score of ${d.score}/10, this department needs immediate attention.`, steps:["Schedule a leadership checkin this week","Review recent workload and deadlines","Consider a team reset session with Wild Bloom","Monitor next week's checkin scores closely"], color:"var(danger)", bg:"var(dlight)" })),
    ...
    ...low.map(d=>({ priority:"healthy", dept:d.dept, score:d.score, title:`${d.dept} is Thriving`, desc:`Score of ${d.score}/10 — this team is in a healthy place. Protect and sustain what's working.`, steps:["Acknowledge and celebrate this team's wellbeing","Document what practices are working here","Consider asking this team to mentor others","Continue monthly checkins to maintain momentum"], color:"var(accent)", bg:"var(alight)" })),
  ];

  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Action Center</div><div className="phtitle">Action Center</div><div className="phsub">Recommended actions based on your current wellness data — {cw||"no data yet"}</div></div>
      {actions.length === 0 ? (
        <div className="card"><div className="empty"><div className="emptyt">No data yet</div></div></div>
      ) : (
        <div style={{display:"flex",flexDirection:"column",gap:14}}>
          {actions.map((a,i)=>(
            <div key={i} className="card" style={{borderLeft:`4px solid ${a.color}`}}>
              <div style={{display:"flex",alignItems:"flexstart",justifyContent:"spacebetween",marginBottom:10}}>
                <div>
              ...
              <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:8}}>
                {a.steps.map((s,j)=>(
                  <div key={j} style={{display:"flex",gap:9,alignItems:"flexstart"}}>
              ...
              <div style={{marginTop:14}}>
                <button onClick={async()=>{
                  await supabase.from("support_requests").insert({ company_code:user.company_code||"", department:a.dept, week:cw, wellness_score:a.score, status:"pending" });
                  try { await fetch("https://formspree.io/f/xkoybvjo",{ method:"POST", headers:{"Accept":"application/json","ContentType":"application/json"}, body:JSON.stringify({ type:"Coaching Request — Action Center", company_code:user.company_code||"N/A", department:a.dept, score:a.score, _subject:`Coaching Request — ${a.dept} — ${user.company_code||"N/A"}` }) }); } catch(e){}
                ...
                }} style={{fontSize:12,padding:"7px 16px",background:"var(ink)",color:"#fff",borderRadius:"var(r)",border:"none",fontWeight:600,fontFamily:"'DM Sans',sansserif",cursor:"pointer"}}>Request Coaching for {a.dept}</button>
              </div>
            </div>
          ))}
        </div>
...
function ResourcesPage() {
  ...
  const resources = [
    { id:1, cat:"Leadership", title:"The Manager's Guide to Burnout Prevention", desc:"A practical framework for recognizing the early signs of burnout in your team before they become performance issues.", content:"Burnout rarely arrives suddenly. The three most reliable early signals are: a decline in the quality of work rather than the quantity, withdrawal from collaborative conversations, and an increase in cynicism or detachment. The right move is a private, lowstakes checkin conversation that asks about capacity, not output." },
    { id:2, cat:"Research", title:"Why High Performers Burn Out First", desc:"Counterintuitive data on who is most at risk in your organization.", content:"The highest performers in any organization are statistically the most burnoutprone. They take on more because they can. They say yes because they're reliable. They don't ask for help because they've built an identity around not needing it. The best managers create deliberate capacity protection for their top performers." },
    { id:3, cat:"Communication", title:"How to Have a Burnout Conversation", desc:"A stepbystep guide for managers on initiating difficult conversations about stress and capacity.", content:"Structure: (1) Open with warmth. (2) Share a specific observation. (3) Ask an open question: 'What's been the heaviest part of your workload recently?' (4) Listen fully before responding. Do not problemsolve in the first conversation. (5) Close with an offer: 'What would feel most helpful right now?'" },
    { id:4, cat:"Culture", title:"Building Psychological Safety in Your Team", desc:"Based on Google's Project Aristotle — the researchbacked practices that make teams perform at their highest level.", content:"Google's fiveyear study found that psychological safety was the single most important factor in team effectiveness. Building it requires four behaviors: (1) Model vulnerability. (2) Respond to bad news with curiosity, not blame. (3) Actively invite dissenting opinions. (4) Follow through on what you say you'll do." },
    { id:5, cat:"Research", title:"The Neuroscience of Stress at Work", desc:"What actually happens in the brain under chronic workplace stress.", content:"Chronic workplace stress accumulates at a level below conscious awareness, gradually raising baseline cortisol, narrowing cognitive bandwidth, and increasing amygdala reactivity. The prefrontal cortex — responsible for complex decisionmaking, empathy, and strategic thinking — is the first casualty of chronic stress." },
    { id:6, cat:"Leadership", title:"The 90Day Retention Reset", desc:"A structured leadership program for stabilizing a team experiencing high turnover or collective burnout.", content:"A 90day retention reset requires three parallel tracks: (1) Structural — audit workload, eliminate lowvalue work. (2) Relational — increase frequency and quality of 1on1 conversations. (3) Cultural — implement one team ritual per week that builds psychological safety." },
    { id:7, cat:"Neuroscience", title:"What Chronic Stress Does to Your Brain", desc:"The science behind why chronic workplace stress is a measurable, physical change to your brain's structure and function.", content:"Chronic stress physically shrinks the grey matter in the prefrontal cortex — the region responsible for decisionmaking, behavioral regulation, emotional control, and empathy. Research led by neuroscientist Amy Arnsten at Yale shows that even moderate chronic stress can impair prefrontal cortex function within weeks. The good news: the brain is neuroplastic and can recover." },
    { id:8, cat:"Neuroscience", title:"The StressPerformance Curve — Where Are You?", desc:"Not all stress is harmful. Understanding this relationship helps leaders and employees optimize their zone.", content:"The YerkesDodson curve shows that performance improves with stress — up to a point. In the optimal zone people are challenged, focused, and performing at their peak. Past that peak, performance collapses. WellPulse checkin data is a realtime map of where your departments sit on that curve." },
  ];

  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Resources Library</div><div className="phtitle">Resources Library</div><div className="phsub">Curated guides, research, and frameworks for leaders on burnout, retention, and team performance</div></div>
      <div style={{display:"grid",gridTemplateColumns:"repeat(autofill,minmax(300px,1fr))",gap:14}}>
        {resources.map(r=>(
...
function CoachingHubPage({ user }) {
  ...
  const services = [
    { id:"group", title:"Monthly Group Coaching Session", desc:"A facilitated 60minute session for your leadership team or a specific department.", duration:"60 minutes", format:"Virtual or OnSite", tier:"Optimize + Transform" },
    { id:"onsite", title:"OnSite Team Workshop", desc:"A half or fullday workshop delivered at your location.", duration:"Half or Full Day", format:"OnSite", tier:"All Tiers (AddOn)" },
    { id:"leadership", title:"Leadership Intensive", desc:"An immersive retreat for senior leadership teams.", duration:"1–3 Days", format:"OffSite Retreat", tier:"Transform + AddOn" },
    { id:"oneone", title:"1on1 Coaching Session", desc:"A confidential 50minute coaching session with a certified Wild Bloom wellness coach.", duration:"50 minutes", format:"Virtual", tier:"Transform + AddOn" },
  ];

  async function requestService(service) {
    setSending(service.id);
    try {
      await fetch("https://formspree.io/f/xkoybvjo", { method:"POST", headers:{"Accept":"application/json","ContentType":"application/json"}, body:JSON.stringify({ type:"Coaching Service Request", service:service.title, company_code:user.company_code||"N/A", _subject:`Coaching Request — ${service.title} — ${user.company_code||"N/A"}` }) });
    } catch(e) {}
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Coaching Hub</div><div className="phtitle">Coaching Hub</div><div className="phsub">Book coaching sessions and workshops directly with Wild Bloom Wellness House</div></div>
      <div className="card" style={{marginBottom:16,background:"var(ink)",border:"none"}}>
        <div style={{display:"flex",alignItems:"center",gap:20}}>
          ...
          <a href="mailto:Miranda@wildbloomwellnesshouse.com" style={{padding:"10px 20px",background:"var(accent)",color:"#fff",borderRadius:"var(r)",textDecoration:"none",fontSize:13,fontWeight:600,fontFamily:"'DM Sans',sansserif",flexShrink:0}}>Contact Miranda</a>
        </div>
      </div>
      <div style={{display:"grid",gridTemplateColumns:"1fr 1fr",gap:14}}>
        {services.map(s=>(
          <div key={s.id} className="card">
            ...
            <button onClick={()=>requestService(s)} disabled={sending===s.id} style={{width:"100%",padding:"9px",background:sent===s.id?"var(alight)":"var(ink)",color:sent===s.id?"var(accent)":"#fff",border:sent===s.id?"1px solid var(accent)":"none",borderRadius:"var(r)",fontFamily:"'DM Sans',sansserif",fontSize:13,fontWeight:600,cursor:"pointer"}}>
...
function MonthlyCheckInPage({ user }) {
  ...
  async function scheduleCheckIn() {
    try {
      await fetch("https://formspree.io/f/xkoybvjo", { method:"POST", headers:{"Accept":"application/json","ContentType":"application/json"}, body:JSON.stringify({ type:"Monthly CheckIn Request", month, company_code:user.company_code||"N/A", notes:note||"No notes provided", _subject:`Monthly CheckIn Request — ${month} — ${user.company_code||"N/A"}` }) });
    } catch(e) {}
    setSubmitted(true);
  }
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · Monthly CheckIns</div><div className="phtitle">Monthly CheckIns</div><div className="phsub">Schedule your monthly leadership conversation with Wild Bloom</div></div>
      <div className="g2">
        <div className="card">
          <div className="ct">Schedule — {month} <div className="ctline"/></div>
          <p style={{fontSize:13,color:"var(soft)",fontWeight:300,lineHeight:1.7,marginBottom:16}}>A 30minute conversation with Miranda to review your WellPulse data, discuss what's working, and align on next steps.</p>
          <div style={{marginBottom:16}}>
            ...
            <textarea value={note} onChange={e=>setNote(e.target.value)} placeholder="e.g. Engineering scores dropped this week..." style={{width:"100%",padding:"10px 12px",border:"1.5px solid var(border)",borderRadius:"var(r)",fontFamily:"'DM Sans',sansserif",fontSize:13,color:"var(ink)",background:"var(surface2)",outline:"none",resize:"vertical",minHeight:80,lineHeight:1.6}}/>
          </div>
          {submitted ? (
            ...
            <button className="btn" onClick={scheduleCheckIn} style={{marginTop:0}}>Schedule Monthly CheckIn</button>
          )}
        </div>
        <div className="card">
          <div className="ct">What to Expect <div className="ctline"/></div>
          {[["WellPulse Data Review","Miranda reviews your latest scores and trends before the call."],["Leadership Conversation","A 30minute focused conversation on what the data means."],["Action Planning","Clear next steps — coaching, team sessions, or structural changes."],["FollowThrough","Miranda follows up if new data suggests your team needs support."]].map(([t,d])=>(
            <div key={t} style={{display:"flex",gap:12,marginBottom:14,alignItems:"flexstart"}}>
...
function EmployeeApp({ user, onLogout }) {
  ...
  const nav = [
    { id:"checkin", label:"Weekly CheckIn", d:<><polyline points="9 11 12 14 22 4"/><path d="M21 12v7a2 2 0 012 2H5a2 2 0 0122V5a2 2 0 0122h11"/></> },
    { id:"stress", label:"Stress Management", d:<><path d="M17 8C8 10 5.9 16.17 3.82 19.34c.2.3.1.66.44.55C5.77 19.26 8.15 18.31 10 17"/><path d="M14 2s1 2 1 42 42 4"/></> },
    { id:"neuro", label:"Team Practices", d:<><path d="M12 5a3 3 0 105.997.125 4 4 0 002.526 5.77 4 4 0 00.556 6.588A4 4 0 1012 18"/><path d="M12 5a3 3 0 115.997.125 4 4 0 012.526 5.77 4 4 0 01.556 6.588A4 4 0 1112 18"/></> },
    { id:"history", label:"My History", d:<><path d="M3 3v5h5"/><path d="M3.05 13A9 9 0 106 5.3L3 8"/><path d="M12 7v5l4 2"/></> },
    ...(tier === "support" ? [{ id:"getsupport", label:"Get Support", d:<><path d="M20.84 4.61a5.5 5.5 0 007.78 0L12 5.67l1.061.06a5.5 5.5 0 007.78 7.78l1.06 1.06L12 21.23l7.787.78 1.061.06a5.5 5.5 0 0007.78z"/></> }] : []),
  ];
    ...
    <>
      <div className="app">
        <nav className="nav">
          <div className="navlogo">WellPulse</div>
          <div className="navsep"/>
          <div className="navctx">Employee Portal</div>
          <div className="navr">
            <div className="navav">{user.name?.[0]?.toUpperCase()}</div>
            <div className="navnm">{user.name} · {user.department}</div>
            <button className="btnnav" onClick={onLogout}>Sign out</button>
          </div>
        </nav>
        <div className="layout">
          <div className="sb">
            <div className="sbsec">Wellness</div>
            {nav.map(item=>(
              <div key={item.id} className={`sbitem ${page===item.id?"on":""}`} onClick={()=>setPage(item.id)}>
                <svg className="sbic" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">{item.d}</svg>
                {item.label}
          ...
          <div className="content mobilecontentpad">
            {page==="checkin" && <CheckInPage user={user}/>}
            {page==="stress" && <ToolkitPage tools={STRESS_TOOLS} title="Stress Management" subtitle="Evidencebased techniques to regulate your nervous system"/>}
            {page==="neuro" && <ToolkitPage tools={NEURO_TOOLS} title="Team Practices" subtitle="Neurological practices to implement in meetings and team settings"/>}
      ...
      <nav className="mobilenav">
        {nav.slice(0,5).map(item=>(
          <button key={item.id} className={`mobilenavitem ${page===item.id?"on":""}`} onClick={()=>setPage(item.id)}>
  ...
  return (
    <div className="ciwrap">
      <div className="cicard">
        {done ? (
          <div className="cidone">
            <div className="cicheck"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#5C7A5C" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
            <h2>Checkin complete</h2>
            ...
            {score !== null && score <= 4 && !supportRequested && (
              <div style={{marginTop:24,background:"var(surface2)",border:"1px solid var(border)",borderRadius:"var(rl)",padding:"20px 22px",textAlign:"left"}}>
                ...
                <button onClick={requestSupport} style={{width:"100%",padding:"11px",background:"var(accent)",color:"#fff",border:"none",borderRadius:"var(r)",fontFamily:"'DM Sans',sansserif",fontSize:14,fontWeight:600,cursor:"pointer",marginBottom:8}}>Yes, I'd like support</button>
                <button onClick={()=>setSupportRequested(true)} style={{width:"100%",padding:"11px",background:"transparent",color:"var(faint)",border:"none",borderRadius:"var(r)",fontFamily:"'DM Sans',sansserif",fontSize:13,cursor:"pointer"}}>No thank you</button>
              </div>
            )}
            ...
            {(score === null || score > 4) && (
              <div className="citip">Visit <strong>Stress Management</strong> or <strong>Team Practices</strong> in the sidebar for tools to support your wellbeing this week.</div>
            )}
          </div>
        ) : (
          <>
            <div className="ciwk">{cw}</div>
            <div className="cititle">Weekly CheckIn</div>
            <div className="cisub">Five questions · approximately two minutes</div>
            <div className="ciprog">{QUESTIONS.map((_,i)=><div key={i} className={`cistep ${i<step?"done":i===step?"cur":""}`}/>)}</div>
            <div className="ciqn">Question {step+1} of {QUESTIONS.length}</div>
            <div className="ciq">{q.label}</div>
            <div className="cihint">{q.hint}</div>
            <div className="cisl">
              ...
              <span className="cisc" style={{color:getRiskColor(val)}}>{val}</span>
            </div>
            <div className="ciscl"><span>Low</span><span>High</span></div>
            <div className="cinav">
              {step>0 ? <button className="btnout" onClick={()=>setStep(step1)}>Back</button> : <div/>}
              {step<QUESTIONS.length1
...
function ToolkitPage({ tools, title, subtitle }) {
  ...
  function startBreath() {
    ...
    let i=0;
    function next() { setPhase(phases[i].p); if(i===0) setCycle(c=>c+1); i=(i+1)%phases.length; timer.current=setTimeout(next,phases[(i+phases.length1)%phases.length].ms); }
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · {title}</div><div className="phtitle">{title}</div><div className="phsub">{subtitle}</div></div>
      <div className="tgrid">
        {tools.map(tool=>(
          <div key={tool.id} className={`tc ${exp===tool.id?"exp":""}`}>
            <div className="tccat">{tool.category}</div>
            <div className="tctitle">{tool.title}</div>
            <div className="tcdesc">{tool.desc}</div>
            <div className="tcbenefit">{tool.benefit}</div>
            <div className="tcmeta">
              <div className="tcdur">{tool.duration}</div>
              <div className="tcbtns">
                <button className="tcbtn why" onClick={()=>setExp(exp===tool.id?null:tool.id)}>{exp===tool.id?"Less":"Why it works"}</button>
                <button className="tcbtn open" onClick={()=>open(tool)}>Open</button>
              </div>
            </div>
          </div>
        ))}
      ...
      {active && active.type==="breathing" && (
        <div className="modalbg" onClick={closeModal}>
          <div className="modal" style={{textAlign:"center"}} onClick={e=>e.stopPropagation()}>
            <div className="mcat">Breathwork</div>
            <div className="mtitle">Box Breathing</div>
            <p style={{fontSize:13,color:"var(soft)",fontWeight:300,marginBottom:6}}>Cycle {cycle} · Tap outside to close</p>
            <div className={`brcircle ${phase==="in"?"in":phase==="out"?"out":"hold"}`}>{phase==="in"?"Breathe In":phase==="out"?"Breathe Out":"Hold"}</div>
      ...
      {active && active.type!=="breathing" && (
        <div className="modalbg" onClick={closeModal}>
          <div className="modal" onClick={e=>e.stopPropagation()}>
            <div className="mcat">{active.category}</div>
            <div className="mtitle">{active.title}</div>
            <div className="mdesc">{active.desc}</div>
            <ol className="msteps">
              {active.steps.map((s,i)=>(<li key={i} className="mstep"><span className="mnum">{i+1}</span><span>{s}</span></li>))}
            </ol>
            <div className="mbenefit"><strong>Why it works</strong>{active.benefit}</div>
            <div className="mactions"><button className="btnout" onClick={closeModal}>Close</button><button className="btn" style={{width:"auto",padding:"10px 22px"}} onClick={closeModal}>Done</button></div>
          </div>
        </div>
      )}
    </div>
...
function SupportPage({ user }) {
  ...
  return (
    <div className="ciwrap" style={{maxWidth:600}}>
      <div className="cicard">
        {submitted ? (
          <div className="cidone">
            <div className="cicheck"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="#5C7A5C" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
          ...
          <>
            <div className="ciwk">Confidential Support</div>
            <div className="cititle">Request Wellness Support</div>
            <div className="cisub" style={{marginBottom:28}}>Sometimes work feels overwhelming. You don't have to navigate it alone.</div>
            <div style={{background:"var(surface2)",border:"1px solid var(border)",borderRadius:"var(rl)",padding:"18px 20px",marginBottom:24}}>
              ...
              {["Your request is completely anonymous — your name is never shared","A certified coach from Wild Bloom Wellness House will be notified","They will work with your HR team to arrange confidential 1on1 support","You control whether and how much you share in any coaching session"].map((s,i)=>(
                <div key={i} style={{display:"flex",gap:10,alignItems:"flexstart",marginBottom:8}}>
            ...
            <div style={{marginBottom:20}}>
              ...
              <textarea value={note} onChange={e=>setNote(e.target.value)} placeholder="e.g. I have been feeling overwhelmed with workload lately..." style={{width:"100%",padding:"10px 12px",border:"1.5px solid var(border)",borderRadius:"var(r)",fontFamily:"'DM Sans',sansserif",fontSize:13,color:"var(ink)",background:"var(surface2)",outline:"none",resize:"vertical",minHeight:90,lineHeight:1.6}}/>
            </div>
...
function HistoryPage({ user }) {
  ...
  return (
    <div className="main">
      <div className="ph"><div className="crumb">WellPulse · My History</div><div className="phtitle">My Wellness History</div><div className="phsub">Your personal checkin record over time</div></div>
      {checkins.length===0 ? (
        <div className="card"><div className="empty"><div className="emptyt">No checkins yet</div><div className="emptys">Complete your first weekly checkin. Your personal wellness trend will appear here over time.</div></div></div>
      ) : (
        <>
          <div className="card" style={{marginBottom:14}}>
            <div className="ct">Wellness Score Over Time <div className="ctline"/></div>
            <ResponsiveContainer width="100%" height={210}>
          ...
          <div className="card">
            <div className="ct">CheckIn History <div className="ctline"/></div>
            <table className="tbl">
                ...
                {checkins.map(c=>{
                  ...
                  return (
                    <tr key={c.id}>
                      ...
                      <td><span className={`badge ${getRisk(s)}`}><span className="badgedot"/>{getRiskLabel(s)}</span></td>
