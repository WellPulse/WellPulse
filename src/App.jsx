...
const STRESS_TOOLS = [
  ...
  { id:13, title:"Stop · Breathe · Reflect · Choose", category:"Daily Practice · Anytime", duration:"2 minutes", type:"guide", desc:"A four-step micro-practice for any moment of stress or reactivity. The goal is awareness — catching yourself before an unhealthy stress response takes over and choosing a healthy one instead.", steps:["STOP — Pause. Put down your phone. Still yourself for 5 seconds. Ask: Am I about to respond from stress or from clarity?","BREATHE — One slow breath. Inhale 4 counts, hold 2, exhale 6. This activates your parasympathetic nervous system within seconds.","REFLECT — Ask: Is this a healthy or unhealthy stress response? Healthy stress motivates and focuses. Unhealthy stress shuts down, isolates, or lashes out. Which one am I in right now?","CHOOSE — From this clearer state, choose your response intentionally. Not a reaction — a choice. One that aligns with who you want to be.","Return to the moment with intention."], benefit:"The gap between stimulus and response is where your freedom lives. This practice widens that gap. Used consistently, it rewires reactive patterns and builds the awareness to distinguish healthy from unhealthy stress responses — the foundation of long-term resilience." },
  { id:14, title:"Healthy vs Unhealthy Stress Awareness", category:"Awareness · Foundation", duration:"5 minutes", type:"guide", desc:"Before you can manage stress, you need to recognize it. Not all stress is harmful — in fact, healthy stress is one of the most powerful performance and growth tools available. This practice builds the awareness to tell the difference.", steps:["HEALTHY STRESS signals: You feel challenged but capable. Energy is elevated. Focus narrows. You're slightly uncomfortable but engaged. There's a sense of meaning in what you're doing.","UNHEALTHY STRESS signals: You feel overwhelmed and helpless. Energy is depleted. You're withdrawn, irritable, or disconnected. Your body feels tight, your mind scattered. Work feels meaningless.","Check in right now: Which category are you in today?","If healthy — use it. Channel the energy. This is your performance zone. Protect it.","If unhealthy — name it without judgment. Say: 'I am in an unhealthy stress response right now. This is information, not failure.'","Then choose one regulation tool from this library — breathwork, grounding, movement, or rest.","Track your pattern over time using WellPulse check-ins. Where does your score consistently drop? That is where unhealthy stress lives in your work life."], benefit:"Awareness is the first stage of the WellPulse wellness framework. You cannot change what you cannot see. Research shows that simply labeling a stress response as healthy or unhealthy reduces its intensity by activating the prefrontal cortex and reducing amygdala reactivity." },
  { id:15, title:"Social Connection as Medicine", category:"Resilience · Daily", duration:"3 minutes", type:"guide", desc:"One of the most underutilized stress regulation tools is also the most human — genuine connection with another person. Research is unambiguous: strong social ties at work reduce burnout, increase resilience, and improve health outcomes measurably.", steps:["Identify one person at work you feel genuinely connected to.","This week, reach out with no agenda — not about a task, not in a meeting. Just a human moment. A coffee, a walk, a two-minute check-in.","In that conversation, ask one real question: 'How are you actually doing?' And mean it.","Share something honest about your own experience in return. Mutual vulnerability strengthens social bonds faster than anything else.","Do this once a week minimum. It takes less time than most meetings and delivers more value than most interventions."], benefit:"Oxytocin — the bonding hormone released during genuine social connection — directly counteracts cortisol, the primary stress hormone. People with strong workplace relationships are 50% less likely to experience clinical burnout and recover from stress significantly faster. Social ties are not a perk. They are a physiological necessity." },
  { id:17, title:"The Three Good Things Practice", category:"Positive Psychology · Daily", duration:"3 minutes", type:"guide", desc:"One of the most replicated findings in positive psychology — writing down three good things that happened each day, and why they happened, measurably increases happiness and reduces depression symptoms within two weeks.", steps:["At the end of each workday, open a notebook or document.","Write down three things that went well today — big or small. A conversation that felt good. A task you completed. A moment of connection. A decision you made well.","For each one, write one sentence about why it happened: 'This happened because I prepared well' or 'because my colleague supported me' or 'because I asked for help.'","Read all three back slowly.","Close the notebook. That's it.","Do this every day for 14 days and notice what shifts."], benefit:"This practice was developed by Dr. Martin Seligman, founder of positive psychology. In clinical trials it produced lasting increases in happiness and reductions in depressive symptoms — effects that persisted even after participants stopped the practice. The 'why it happened' element is critical — it builds internal attribution and a sense of agency." },
  { id:18, title:"Strengths Awareness at Work", category:"Positive Psychology · Weekly", duration:"10 minutes", type:"guide", desc:"Positive psychology research consistently shows that people who use their signature strengths at work are more engaged, less burned out, and more productive. This practice helps you identify and deliberately activate yours.", steps:["Ask yourself: When at work do I feel most energized, most natural, most like myself?","Write down three to five activities or moments that consistently produce that feeling.","These are clues to your signature strengths. Common workplace strengths: creativity, leadership, empathy, learning, fairness, humor, persistence, curiosity.","This week, look for one opportunity each day to use one of these strengths — even in a small way.","At the end of the week, notice: did the days where you used your strengths feel different from the days where you didn't?","Share one of your strengths with a colleague and ask them what they think your strengths are. Other people often see our strengths more clearly than we do."], benefit:"People who use their top strengths at work experience 23% higher engagement and 72% lower burnout rates according to Gallup research. Strengths-based work is not about ignoring weaknesses — it is about spending enough time in your strength zone that you have the energy to manage everything else." },
  { id:19, title:"Gratitude as a Nervous System Tool", category:"Positive Psychology · Daily", duration:"2 minutes", type:"guide", desc:"Gratitude is not just a feel-good practice — it is a measurable nervous system intervention. Genuine gratitude activates the brain's reward system, releases dopamine and serotonin, and directly counteracts the physiological effects of chronic stress.", steps:["Once a day — morning or evening — pause for two minutes.","Bring to mind one person, one experience, or one thing at work you are genuinely grateful for. Not obligated to be grateful for — genuinely grateful for.","Feel the gratitude physically. Where do you notice it in your body? Warmth? Relaxation? A softening somewhere?","If you want to deepen the practice: write it down, or tell the person directly.","The key word is genuine. Forced gratitude has little effect. Real gratitude — even for something small — has measurable physiological impact within minutes."], benefit:"Gratitude activates the hypothalamus, which regulates sleep, metabolism, and stress. It increases dopamine production, which creates a positive feedback loop — the more you practice, the more your brain naturally looks for things to be grateful for. MRI studies show that gratitude literally changes brain structure over time." },
  { id:20, title:"Meaning-Making at Work", category:"Positive Psychology · Weekly", duration:"8 minutes", type:"guide", desc:"Viktor Frankl's research from the most extreme conditions imaginable showed that meaning is the most powerful human motivator — more than comfort, safety, or even happiness. This practice helps you find and strengthen it in your daily work.", steps:["Set aside 8 minutes at the end of your week.","Ask: Who did my work serve this week? Even indirectly — who benefited from something I did?","Ask: What did I contribute that I am proud of? Not necessarily the biggest thing. The most real thing.","Ask: What does this work allow me to do or provide outside of work? Family, freedom, growth, contribution — what does it make possible?","Write the answers down. Read them slowly.","If this exercise feels empty — if you genuinely cannot find meaning — that is important information. It may be time for a conversation with your manager, a coaching session, or a deeper reflection on alignment."], benefit:"Research by Adam Grant shows that people who understand the impact of their work are significantly more motivated and resilient. Meaning-based motivation is far more burnout-resistant than achievement-based motivation because it connects to identity rather than outcome." },
  { id:16, title:"Building Your Resilience Foundation", category:"Resilience · Long-Term", duration:"10 minutes", type:"guide", desc:"Resilience is not a personality trait. It is a skill — built through consistent practice over time. This guide walks you through the four-stage WellPulse resilience framework used across all coaching and platform practices.", steps:["STAGE 1 — AWARENESS: Learn to recognize your stress patterns. Use WellPulse check-ins to track your data. Notice which categories drop first — that is your personal stress signature.","STAGE 2 — REGULATION: Learn to evoke the relaxation response on demand. Pick two or three tools from this library and practice them daily until they become automatic. Breathwork, grounding, and the Stop-Breathe-Reflect-Choose practice are the best starting points.","STAGE 3 — RESILIENCE: Once you can regulate, begin building capacity. Resilience means you recover faster — not that you avoid difficulty. Expose yourself to manageable challenges. Debrief them honestly. Celebrate recovery, not just endurance.","STAGE 4 — MAINTENANCE: Sustain what works. Build non-negotiable daily practices. Protect your sleep, your social connections, and your recovery time. Schedule monthly check-ins with a coach or trusted colleague to maintain momentum.","Review where you are in this framework today. Which stage are you in?"], benefit:"The research on resilience is clear — it is built, not born. The four-stage model mirrors the evidence base from neuroscience, positive psychology, and occupational health. Companies that support employees through all four stages see measurably lower turnover, lower absenteeism, and higher sustained performance over time." },
];
...
function LandingPage({ onSignIn }) {
  ...
  async function handleDemo(e) {
    ...
    setSending(true);
    try {
      await fetch("https://formspree.io/f/mpqbrppl", {
        method: "POST",
    ...
    <div style={{fontFamily:"'DM Sans',sans-serif",background:"#F5F0EA",minHeight:"100vh",color:"#1E1A14"}}>
        ...
        <div style={{maxWidth:1200,margin:"0 auto",width:"100%",display:"grid",gridTemplateColumns:"1fr 1fr",gap:80,alignItems:"center",position:"relative",zIndex:1}}>
          <div>
            ...
            <div style={{display:"flex",gap:14,alignItems:"center"}}>
              <a href="#demo" style={{padding:"14px 32px",background:"#FDFCF9",color:"#1E1A14",borderRadius:4,fontSize:15,fontWeight:600,textDecoration:"none",transition:"all .2s"}}>Request a Demo</a>
          ...
          <div style={{background:"#FDFCF9",border:"1px solid #E2D9CE",borderRadius:12,overflow:"hidden",boxShadow:"0 20px 60px rgba(0,0,0,0.4)"}}>
            ...
            <div style={{padding:20}}>
              ...
              {[["Marketing","84%","#4A6741","8.4","Low"],["Engineering","51%","#C4956A","5.1","Med"],["Operations","34%","#A0522D","3.4","High"]].map(([d,w,c,s,r])=>(
                <div key={d} style={{display:"flex",alignItems:"center",gap:8,marginBottom:8}}>
                  ...
                  <span style={{fontSize:8,fontWeight:700,padding:"2px 6px",borderRadius:10,background:c==="#4A6741"?"#EEF3EE":c==="#C4956A"?"#FBF3EA":"#F9EDE6",color:c}}>{r}</span>
                </div>
              ))}
            </div>
          </div>
      ...
      <div style={{background:"#1E1A14",padding:"60px 48px"}}>
        <div style={{maxWidth:1200,margin:"0 auto",display:"grid",gridTemplateColumns:"repeat(4,1fr)"}}>
          {[["$1T","Lost annually to workplace stress globally"],["3×","More likely to leave when burned out"],["68%","Of employees are disengaged right now"],["2min","To complete a WellPulse check-in"]].map(([n,l])=>(
      ...
      <div id="who" style={{background:"#FDFCF9",padding:"100px 48px",borderTop:"1px solid #E2D9CE",borderBottom:"1px solid #E2D9CE"}}>
        <div style={{maxWidth:1200,margin:"0 auto"}}>
          ...
          <h2 style={{fontFamily:"'DM Serif Display',serif",fontSize:"clamp(30px,4vw,50px)",color:"#1E1A14",marginBottom:18,maxWidth:640}}>Built for organizations that take their people <em style={{fontStyle:"italic",color:"#4A6741"}}>seriously.</em></h2>
          <p style={{fontSize:16,color:"#6B5D4F",fontWeight:300,lineHeight:1.75,maxWidth:560,marginBottom:40}}>WellPulse is designed for companies of 25 to 5,000 employees who understand that culture is a competitive advantage.</p>
          <div style={{display:"grid",gridTemplateColumns:"repeat(3,1fr)",gap:2,background:"#E2D9CE",borderRadius:12,overflow:"hidden"}}>
            {[["HR & People Operations","You need early warning signals and data to justify wellness investment to leadership. WellPulse gives you both."],
              ["CEOs & Founders","You understand that culture is a competitive advantage. WellPulse keeps a real-time pulse on it — without micromanaging."],
              ["Department Leaders","You want to be a good manager but lack the tools to see what's happening beneath the surface of weekly standups."]
            ].map(([t,d])=>(
      ...
      <div id="coaching" style={{background:"#2C3D28",padding:"100px 48px"}}>
        <div style={{maxWidth:1200,margin:"0 auto",display:"grid",gridTemplateColumns:"1fr 1fr",gap:72,alignItems:"center"}}>
          <div>
            ...
            <h2 style={{fontFamily:"'DM Serif Display',serif",fontSize:"clamp(28px,3.5vw,46px)",color:"#FDFCF9",lineHeight:1.1,marginBottom:18}}>Data tells you where the problem is. People help you solve it.</h2>
            <p style={{fontSize:16,color:"rgba(253,252,249,0.55)",fontWeight:300,lineHeight:1.75,marginBottom:32}}>WellPulse is built in partnership with Wild Bloom Wellness House — a certified coaching practice specializing in burnout recovery, stress management, and nervous system regulation.</p>
        ...
        <div style={{background:"#FDFCF9",border:"1px solid #E2D9CE",borderRadius:12,padding:44,maxWidth:540,margin:"0 auto",boxShadow:"0 4px 32px rgba(30,26,20,0.1)",textAlign:"left"}}>
          {submitted ? (
            ...
            <>
              ...
              <button onClick={handleDemo} disabled={sending} style={{width:"100%",padding:13,background:"#1E1A14",color:"#fff",border:"none",borderRadius:4,fontFamily:"'DM Sans',sans-serif",fontSize:15,fontWeight:600,cursor:"pointer",marginTop:14}}>
