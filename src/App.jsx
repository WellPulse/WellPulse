                ...
                {checkins.map(c=>{
                  ...
                  return (
                    ...
                    <div className="card" style={{border:"1.5px solid var(--border)"}}>
                      ...
                      {[
                        "Weekly 5-question wellness check-ins",
                        "Real-time leadership dashboard",
                        "Department burnout risk scores",
                        "Weekly and monthly trend reports",
                        "Risk classification — Low, Medium, High",
                        "Wellness toolkit for all employees",
                        "Downloadable export reports",
                      ...
                      {[
                        "Wild Bloom Wellness House coaching connection",
                        "Manager coaching and leadership support",
                        "Team workshop facilitation",
                        "Nervous system regulation training for teams",
                        "Stress management practices for meetings"
                      ].map(f=>(
                        <div key={f} style={{display:"flex",gap:9,alignItems:"flex-start",marginBottom:8}}>
                      ...
                      <div style={{height:1,background:"var(--border)",margin:"14px 0"}}/>
                      <div style={{fontSize:10,fontWeight:700,color:"var(--faint)",textTransform:"uppercase",letterSpacing:".08em",marginBottom:10}}>Not Available in This Tier</div>
                      {[
                        "1-on-1 confidential employee coaching",
                        "Anonymous employee support requests",
                        "Low wellness score auto-prompt"
                      ].map(f=>(
                    ...
                    <div className="card" style={{border:"2px solid var(--ink)",position:"relative"}}>
                      ...
                      {[
                        "1-on-1 confidential employee coaching sessions",
                        "Anonymous support request from employee portal",
                        "Low wellness score auto-prompt for at-risk employees",
                        "Direct coaching access button in employee sidebar",
                        "Anonymous support tracking in owner dashboard"
                      ].map(f=>(
                        <div key={f} style={{display:"flex",gap:9,alignItems:"flex-start",marginBottom:8}}>
                          <svg style={{flexShrink:0,marginTop:2}} width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#5C7A5C" strokeWidth="2.5"><polyline points="20 6 9 17 4 12"/></svg>
                      ...
                      <div style={{marginTop:16,padding:"12px 14px",background:"var(--alight)",borderRadius:"var(--r)",fontSize:12,color:"var(--accent)",fontWeight:400,lineHeight:1.6,borderLeft:"3px solid var(--accent)"}}>
